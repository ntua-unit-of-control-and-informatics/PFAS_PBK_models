...
# based on the work of Li et al., 2013, https://doi.org/10.3109/17435390.2013.863406
    ...
    Pup_Li <- estimated_params[25]
    Km_Li <- estimated_params[26]
    CLup <- estimated_params[27]
  ...
  #========================================================================================================
    ...
    dMLi =  QLi*CBart - QLitot*(CLi/coef_liver) + QSt*(CSt/coef_stomach) + QSpl*(CSpl/coef_spleen) + 
            ...
            Pup_Li*V_macro_Li*CLi*(1-(Cmacro_Li/(Km_Li + Cmacro_Li)))
...
N_pars <- 27 # Number of parameters to be fitted
fit <-  c(rep(log(1), 27))
 
lb = c(rep(log(1e-10),27))
ub = c(rep(log(1e10),27))

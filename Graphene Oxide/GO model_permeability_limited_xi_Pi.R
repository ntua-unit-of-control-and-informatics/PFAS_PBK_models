...
# based on the work of Li et al., 2013, https://doi.org/10.3109/17435390.2013.863406
    ...
    if(np_size == "np_size_small"){
      ...
      xi_liver <- estimated_params[13]
      xi_spleen <- estimated_params[14]
      xi_kidney <- estimated_params[15]
      xi_heart <- estimated_params[16]
      xi_lung <- estimated_params[17]
      xi_rob <- estimated_params[18]
      xi_stomach <- estimated_params[19]
      xi_smallIn <- estimated_params[20]
      xi_largeIn <- estimated_params[21]
      xi_brain <- estimated_params[22]

...
create.params <- function(BW) {
  ...
  RAFbaso <- 9.6494055 # relative activity factor, basolateral transporters (male)
  RAFapi <-  0.00001 # relative activity factor, apical transporters (male); fitted to model
  ...
  PL <- 1.1104999 # liver:blood
  PR <- 0.1721085# rest of body:blood
  ...
  kbilec <- 0.0001 * 24  # biliary elimination rate (1/(day*BW^-0.25)); fitted to model 
  kurinec <- 8.3334430 #0.063 * 24  # urinary elimination rate (1/(day*BW^-0.25))

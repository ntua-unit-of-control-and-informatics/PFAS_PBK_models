...
create.inits <- function(parameters){
  with(as.list(parameters),{
    M_art<-10; M_venous<-10;
    M_gills<-10; M_lumen=100; M_lumen_2=10; M_viscera<-10; M_liver<-10; M_kidney<-10;
    M_muscle<-10; M_skin<-10; M_carcass<-10; M_storage<-10; M_urine<-10; M_feces<-10; M_input<-10;
    C_gills=10; C_viscera=10; C_liver=10; C_kidney=10; C_muscle=10; 
    C_skin=10; C_carcass=10; C_lumen=10; C_art=10; C_venous=10; 
    C_blood=10; C_storage=10;
    ...
    return(c('M_art'=M_art, 'M_venous'=M_venous, 'M_gills'=M_gills, 'M_lumen'=M_lumen,
             ...
             'M_storage'=M_storage,
             'C_gills'=C_gills, 'C_viscera'=C_viscera, 'C_liver'=C_liver, 'C_kidney'=C_kidney, 'C_muscle'=C_muscle, 
             'C_skin'=C_skin, 'C_carcass'=C_carcass, 'C_lumen'=C_lumen, 'C_art'=C_art, 'C_venous'=C_venous, 
             'C_blood'=C_blood, 'C_storage'=C_storage,
...
ode.func <- function(time, states, params){
  with(as.list(c(states, params)),{
    ...
    dC_venous = dM_venous/w_venous
    
    dC_blood = (dM_art + dM_venous)*plasma/w_blood
    
    # Gills
    dM_gills <- Q_gills*(C_venous - C_gills/P_gills)
    dC_gills = dM_gills/w_gills 
    
    dM_input=0
    
  
    # Viscera lumen - Available PFAS for absorption and elimination
    dM_lumen = - Ku*a*M_lumen - Cl_feces*(1-a)*M_lumen + 0.26873687
    ...
    return(list(c('dM_art'=dM_art, 'dM_venous'=dM_venous, 
                ...
                'dC_Gills'=dC_gills, 'dC_Viscera'=dC_viscera,
                'dC_Liver'=dC_liver, 'dC_Kidney'=dC_kidney, 'dC_Muscle'=dC_muscle,
                'dC_Skin'=dC_skin, 'dC_Carcass'=dC_carcass, 'dC_Lumen'=dC_lumen,
                'dC_art'=dC_art, 'dC_venous'=dC_venous, 'dC_blood'=dC_blood*plasma,
                'dC_storage'=dC_storage,
                'Mass_balance'=Mass_balance, 'BW'=BW, 'M_art'=M_art, 'M_venous'=M_venous, 'w_blood'=w_blood)))
  })
}
...
############################
optimized_params <- c(1.4242889930, 0.0005210038, 1.3583221351, 
                      1.5685318, 0.11316576, 0.4398762, 0.2715996, 0.2291869, 0.1074253, 3.699111e+00)
substances <- c("PFOS")
parameters_names <- c('Ku', 'CLU_coef', 'Cl_feces', 
                      'P_liver', 'P_muscle', 'P_kidney', 
...
states <- create.inits(params)
events <- create.events(params)
sample_time <- seq(0,56*24,2)

ode.func(time=24, states=states, params = params)

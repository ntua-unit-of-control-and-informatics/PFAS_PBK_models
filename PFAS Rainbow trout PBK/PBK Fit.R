...
plot <- ggplot()+
  geom_line(data = predictions_df, aes(x = time, y = C_Liver, color='Liver'), size=1.7)+
  geom_line(data = predictions_df, aes(x = time, y = C_Blood, color='Blood'), size=1.7)+
  geom_line(data = predictions_df, aes(x = time, y = C_Skin, color='Skin'), size=1.7)+
  geom_line(data = predictions_df, aes(x = time, y = C_Muscle, color='Muscle'), size=1.7)+
  geom_line(data = predictions_df, aes(x = time, y = C_Gills, color='Gills'), size=1.7)+
  geom_line(data = predictions_df, aes(x = time, y = C_Kidney, color='Kidney'), size=1.7)+
  geom_line(data = predictions_df, aes(x = time, y = C_Carcass, color='Carcass'), size=1.7)+
  ...
  labs(title = "Tissues Predicted vs Observed Concentrations ",

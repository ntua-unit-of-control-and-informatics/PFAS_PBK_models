...
################################################################
x0 <- c('P_liver'= 0.4949579, #2.05,
        'P_muscle' = 0.05760052, #0.15,
        'P_kidney' = 0.02340579 , #0.58,
        'P_skin' = 0.1298301, # 0.25,
        'P_gills' = 0.1066545  , #0.1066545 , #0.40,
        'P_carcass' = 0.04719338  ,
        'Cl_bile' = 15, #2.16e-06, # L/h
        'Cl_feces' = 0.01929406 , #2.62e-07, # L/h
        'Cl_urine' = 0.7027037) #7e-05) # L/h 

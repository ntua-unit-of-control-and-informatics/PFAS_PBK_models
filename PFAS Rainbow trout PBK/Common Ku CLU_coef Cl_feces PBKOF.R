...
params_names <- c('Ku', 'CLU_coef', 'Cl_feces', 'P_liver', 'P_muscle', 'P_kidney', 
                  'P_skin', 'P_gills', 'P_carcass', 'P_viscera')
set.seed(0)
#x0 <- c(0.8,0.06, 0.1, runif(5*7))
x0 <- c(1.4242889930, 0.0005210038, 1.3583221351,
        1.5955778, 0.11324562, 0.4714780, 0.2749829, 0.2311812, 0.10879549, 3.652317e+00,
        2.1085681, 0.03927779, 0.9245954, 0.3339991, 0.3599769, 0.19057927, 4.642846e-01,
        1.8212530, 0.13772295, 0.8167517, 0.2305010, 0.2872912, 0.11668552, 1.016563e-05,
        1.7551598, 0.04373155, 0.3940847, 0.2976659, 0.1572163, 0.04178989, 1.000000e-05,
        0.8068349, 0.06523193, 0.2612654, 0.2344562, 0.2213334, 0.11318794, 1.169186e+00)

start_time <- Sys.time()
optimization <- nloptr::nloptr( x0 = x0,
                                eval_f = obj.func,
                                lb	= rep(1e-07, length(x0)),

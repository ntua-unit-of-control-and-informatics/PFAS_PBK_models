...
create_variable_params <- function(test_pars, BW,sex,   fixed_params){
  ...
  kabsUA <-0.1 *test_pars[1]#L/h/m^2
  kCLEua <- 0 #L/h/m^2
  ...
  RAFOat3 <- 9.859003e+03*test_pars[2]
  ...
  reduction_factor <- 3.714130e-02*test_pars[3]
  ...
  return(list(
    ...
    "koff_a2u" = koff_a2u, "koff_fabp" = koff_fabp,
    "kon_a2u" = kon_a2u, "kon_fabp" = kon_fabp,
...
ode.func <- function(time, inits, params){
  ...
  with(as.list(c(inits, params)),{
    ...
    fu_from_albumin <- function(Calbumin) 1 / (1 + Ka * Calbumin)
    
    fuVen <- fu_from_albumin(CalbVenf)
    fuArt <- fu_from_albumin(CalbArtf)
    fuKB <- fu_from_albumin(CalbKBf)
    fuLB <- fu_from_albumin(CalbLBf)
    fuSTB <- fu_from_albumin(CalbSTBf)
    fuINB <- fu_from_albumin(CalbINBf)
    fuMB <- fu_from_albumin(CalbMBf)
    fuAB <- fu_from_albumin(CalbABf)
    fuRB <- fu_from_albumin(CalbRBf)
    fuLuB <- fu_from_albumin(CalbLuBf)
    fuSPB <- fu_from_albumin(CalbSPBf)
    fuHB <- fu_from_albumin(CalbHBf)
    fuBrB <- fu_from_albumin(CalbBrBf)
    fuGoB <- fu_from_albumin(CalbGoBf)
    fuSKB <- fu_from_albumin(CalbSKBf)
    fuBoB <- fu_from_albumin(CalbBoBf)
    
    fuKF <- fu_from_albumin(CalbKFf)
    fuLF <- fu_from_albumin(CalbLFf)
    fuSTF <- fu_from_albumin(CalbSTFf)
    fuINF <- fu_from_albumin(CalbINFf)
    fuMF <- fu_from_albumin(CalbMFf)
    fuAF <- fu_from_albumin(CalbAFf)
    fuRF <- fu_from_albumin(CalbRFf)
    fuLuF <- fu_from_albumin(CalbLuFf)
    fuSPF <- fu_from_albumin(CalbSPFf)
    fuHF <- fu_from_albumin(CalbHFf)
    fuBrF <- fu_from_albumin(CalbBrFf)
    fuGoF <- fu_from_albumin(CalbGoFf)
    fuSKF <- fu_from_albumin(CalbSKFf)
    fuBoF <- fu_from_albumin(CalbBoFf)
    fuLuAF <- fu_from_albumin(CalbLuAFf)
    ...
    #Albumin concentrations are treated as fixed and determine fu algebraically.
    dCalbVenf <- 0
    dCalbArtf <- 0
    dCalbKBf <- 0
    dCalbLBf <- 0
    ...
    #Venous Blood
    dMVen_tot = kUAB*CUA - CVenf*QBLu + QBK*CKBf + QBLtot*CLBf + QBM*CMBf + QBA*CABf + QBR*CRBf+
    ...
    #Liver
    #blood subcompartment
    dMLB_tot = QBL*CArtf + QBSP*CSPBf + QBIN*CINBf + QBST*CSTBf - 
      QBLtot*CLBf - (Ptrans_diff_L+PparaLi)*AL*(CLBf-CLFf)
    #interstitial fluid subcompartment 
    dMLF_tot = (Ptrans_diff_L+PparaLi)*AL*(CLBf-CLFf) - kLFLT*(CLFf-CLTf) - 
    ...
    #Stomach
    #blood subcompartment
    dMSTB_tot = QBST*CArtf - QBST*CSTBf - (Ptrans_diff_ST+PparaSt)*AST*(CSTBf-CSTFf)
    #interstitial fluid subcompartment 
    dMSTF_tot = (Ptrans_diff_ST+PparaSt)*AST*(CSTBf-CSTFf) - kSTFSTT*(CSTFf-CSTTf)
    ...
    #Intestine
    #blood subcompartment
    dMINB_tot = QBIN*CArtf - QBIN*CINBf - (Ptrans_diff_IN+PparaIn)*AIN*(CINBf-CINFf)
    #interstitial fluid subcompartment 
    dMINF_tot = (Ptrans_diff_IN+PparaIn)*AIN*(CINBf-CINFf) - kINFINT*(CINFf-CINTf)
    ...
    #Muscle
    #blood subcompartment
    dMMB_tot = QBM*CArtf - QBM*CMBf - (Ptrans_diff_M+PparaMu)*AM*(CMBf-CMFf)
    #interstitial fluid subcompartment 
    dMMF_tot = (Ptrans_diff_M+PparaMu)*AM*(CMBf-CMFf) - kMFMT*(CMFf- CMTf)
    #Muscle tissue subcompartment 
    dMMTf = kMFMT*(CMFf- CMTf) 
    
    #Adipose
    #blood subcompartment
    dMAB_tot = QBA*CArtf - QBA*CABf - (Ptrans_diff_A+PparaAd)*AA*(CABf-CAFf)
    #interstitial fluid subcompartment 
    dMAF_tot = (Ptrans_diff_A+PparaAd)*AA*(CABf-CAFf)  - kAFAT*(CAFf-CATf)
    #Adipose tissue subcompartment 
    dMATf =  kAFAT*(CAFf-CATf)
    
    #Rest of body
    #blood subcompartment
    dMRB_tot = QBR*CArtf - QBR*CRBf - (Ptrans_diff_R+PparaRe)*AR*(CRBf-CRFf)
    #interstitial fluid subcompartment 
    dMRF_tot = (Ptrans_diff_R+PparaRe)*AR*(CRBf-CRFf) - kRFRT*(CRFf -CRTf)
    ...
    #blood subcompartment
    dMLuB_tot = CVenf*QBLu - QBLu*CLuBf - (Ptrans_diff_Lu+PparaLu)*ALu*(CLuBf-CLuFf)
    #interstitial fluid subcompartment
    dMLuF_tot = (Ptrans_diff_Lu+PparaLu)*ALu*(CLuBf-CLuFf) + kLuTLuF*(CLuTf-CLuFf) - 
    ...
    dMLuAF_tot = k_desorption_fast * MLuAFdust_fast + k_desorption_slow * MLuAFdust_slow + kLuTLuAF*(CLuTf-CLuAFf) - 
      (VmLu_Oatp_ap*CLuAFf/(KmLu_Oatp_ap+CLuAFf)) 
    ...
    #Spleen
    #blood subcompartment
    dMSPB_tot = QBSP*CArtf - QBSP*CSPBf - (Ptrans_diff_SP+PparaSp)*ASP*(CSPBf-CSPFf)
    #interstitial fluid subcompartment 
    dMSPF_tot = (Ptrans_diff_SP+PparaSp)*ASP*(CSPBf-CSPFf) - kSPFSPT*(CSPFf -CSPTf)
    #Spleen tissue subcompartment 
    dMSPTf = kSPFSPT*(CSPFf -CSPTf)
    
    #Heart
    #blood subcompartment
    dMHB_tot = QBH*CArtf - QBH*CHBf - (Ptrans_diff_H+PparaHt)*AH*(CHBf-CHFf)
    #interstitial fluid subcompartment 
    dMHF_tot = (Ptrans_diff_H+PparaHt)*AH*(CHBf-CHFf) - kHFHT*(CHFf -CHTf)
    #Heart tissue subcompartment 
    dMHTf = kHFHT*(CHFf -CHTf) 
    
    #Brain
    #blood subcompartment
    dMBrB_tot = QBBr*CArtf - QBBr*CBrBf - (Ptrans_diff_Br+PparaBr)*ABr*(CBrBf-CBrFf)
    #interstitial fluid subcompartment 
    dMBrF_tot = (Ptrans_diff_Br+PparaBr)*ABr*(CBrBf-CBrFf) - kBrFBrT*(CBrFf -CBrTf)
    #Brain tissue subcompartment 
    dMBrTf = kBrFBrT*(CBrFf -CBrTf) 
    
    #Gonads
    #blood subcompartment
    dMGoB_tot = QBGo*CArtf - QBGo*CGoBf - (Ptrans_diff_Go+PparaGo)*AGo*(CGoBf-CGoFf)
    #interstitial fluid subcompartment 
    dMGoF_tot = (Ptrans_diff_Go+PparaGo)*AGo*(CGoBf-CGoFf) - kGoFGoT*(CGoFf -CGoTf)
    #gonads tissue subcompartment 
    dMGoTf = kGoFGoT*(CGoFf -CGoTf) 
    
    #Skin
    #blood subcompartment
    dMSKB_tot = QBSK*CArtf - QBSK*CSKBf - (Ptrans_diff_SK+PparaSk)*ASK*(CSKBf-CSKFf)
    #interstitial fluid subcompartment
    dMSKF_tot = (Ptrans_diff_SK+PparaSk)*ASK*(CSKBf-CSKFf) - kSKFSKT*(CSKFf -CSKTf)
    #Skin tissue subcompartment
    dMSKTf = kSKFSKT*(CSKFf -CSKTf) 
    
    #Bones
    #blood subcompartment
    dMBoB_tot = QBBo*CArtf - QBBo*CBoBf - (Ptrans_diff_Bo+PparaBo)*ABo*(CBoBf-CBoFf)
    #interstitial fluid subcompartment
    dMBoF_tot = (Ptrans_diff_Bo+PparaBo)*ABo*(CBoBf-CBoFf) - kBoFBoT*(CBoFf -CBoTf)
    #Bones tissue subcompartment
    dMBoTf = kBoFBoT*(CBoFf -CBoTf) 
    
    dMVenf <- fuVen * dMVen_tot
    dMVenb <- (1 - fuVen) * dMVen_tot
    dMArtf <- fuArt * dMArt_tot
    dMArtb <- (1 - fuArt) * dMArt_tot
    dMKBf <- fuKB * dMKB_tot
    dMKBb <- (1 - fuKB) * dMKB_tot
    dMKFf <- fuKF * dMKF_tot
    dMKFb <- (1 - fuKF) * dMKF_tot
    dMLBf <- fuLB * dMLB_tot
    dMLBb <- (1 - fuLB) * dMLB_tot
    dMLFf <- fuLF * dMLF_tot
    dMLFb <- (1 - fuLF) * dMLF_tot
    dMSTBf <- fuSTB * dMSTB_tot
    dMSTBb <- (1 - fuSTB) * dMSTB_tot
    dMSTFf <- fuSTF * dMSTF_tot
    dMSTFb <- (1 - fuSTF) * dMSTF_tot
    dMINBf <- fuINB * dMINB_tot
    dMINBb <- (1 - fuINB) * dMINB_tot
    dMINFf <- fuINF * dMINF_tot
    dMINFb <- (1 - fuINF) * dMINF_tot
    dMMBf <- fuMB * dMMB_tot
    dMMBb <- (1 - fuMB) * dMMB_tot
    dMMFf <- fuMF * dMMF_tot
    dMMFb <- (1 - fuMF) * dMMF_tot
    dMABf <- fuAB * dMAB_tot
    dMABb <- (1 - fuAB) * dMAB_tot
    dMAFf <- fuAF * dMAF_tot
    dMAFb <- (1 - fuAF) * dMAF_tot
    dMRBf <- fuRB * dMRB_tot
    dMRBb <- (1 - fuRB) * dMRB_tot
    dMRFf <- fuRF * dMRF_tot
    dMRFb <- (1 - fuRF) * dMRF_tot
    dMLuBf <- fuLuB * dMLuB_tot
    dMLuBb <- (1 - fuLuB) * dMLuB_tot
    dMLuFf <- fuLuF * dMLuF_tot
    dMLuFb <- (1 - fuLuF) * dMLuF_tot
    dMLuAFf <- fuLuAF * dMLuAF_tot
    dMLuAFb <- (1 - fuLuAF) * dMLuAF_tot
    dMSPBf <- fuSPB * dMSPB_tot
    dMSPBb <- (1 - fuSPB) * dMSPB_tot
    dMSPFf <- fuSPF * dMSPF_tot
    dMSPFb <- (1 - fuSPF) * dMSPF_tot
    dMHBf <- fuHB * dMHB_tot
    dMHBb <- (1 - fuHB) * dMHB_tot
    dMHFf <- fuHF * dMHF_tot
    dMHFb <- (1 - fuHF) * dMHF_tot
    dMBrBf <- fuBrB * dMBrB_tot
    dMBrBb <- (1 - fuBrB) * dMBrB_tot
    dMBrFf <- fuBrF * dMBrF_tot
    dMBrFb <- (1 - fuBrF) * dMBrF_tot
    dMGoBf <- fuGoB * dMGoB_tot
    dMGoBb <- (1 - fuGoB) * dMGoB_tot
    dMGoFf <- fuGoF * dMGoF_tot
    dMGoFb <- (1 - fuGoF) * dMGoF_tot
    dMSKBf <- fuSKB * dMSKB_tot
    dMSKBb <- (1 - fuSKB) * dMSKB_tot
    dMSKFf <- fuSKF * dMSKF_tot
    dMSKFb <- (1 - fuSKF) * dMSKF_tot
    dMBoBf <- fuBoB * dMBoB_tot
    dMBoBb <- (1 - fuBoB) * dMBoB_tot
    dMBoFf <- fuBoF * dMBoF_tot
    dMBoFb <- (1 - fuBoF) * dMBoF_tot
    ...
    Clungs <-  (MLuB + MLuF+ MLuT + MLuAF+Mdust+Cblood*VLuB_lv)/VLu_tot
    Clungtissue <- (MLuB + MLuF+ MLuT+ Cblood*VLuB_lv+Mdust*fdust_retained)/(VLuB+VLuF+VLuT)
    CUpperair <- MUA/VUA
    ...
    Ckidney_bled <- (MKB + MKF+ MKT + Mfil)/(VKi_tot-VKiB_lv)
    Cliver_bled <- (MLB + MLF+ MLT + MBile )/(VLi_tot-VLiB_lv)
    Cintestine_bled <-  (MINB + MINF+ MINT+MINL)/(VIn_tot-VInB_lv)
    Cstomach_bled <-  (MSTB + MSTF+ MSTT + MSTL)/(VSt_tot-VStB_lv)
    Cmuscle_bled <-  (MMB + MMF+ MMT)/(VMu_tot-VMuB_lv)
    Cadipose_bled <-  (MAB + MAF+ MAT)/(VAd_tot-VAdB_lv)
    Clungs_bled <-  (MLuB + MLuF+ MLuT + MLuAF+Mdust*fdust_retained)/(VLu_tot-VLuB_lv)
    Clungtissue_bled <- (MLuB + MLuF+ MLuT+Mdust*fdust_retained)/(VLuB+VLuF+VLuT-VLuB_lv)
    Cspleen_bled <-  (MSPB + MSPF+ MSPT)/(VSp_tot)
    Cheart_bled <-  (MHB + MHF+ MHT)/(VHt_tot-VHtB_lv)
    Cbrain_bled <-  (MBrB + MBrF+ MBrT)/(VBr_tot-VBrB_lv)
    Cgonads_bled <-  (MGoB + MGoF+ MGoT)/(VGo_tot-VGoB_lv)
    Cskin_bled <-  (MSKB + MSKF+ MSKT)/(VSk_tot-VSkB_lv)
    Cbones_bled <-  (MBoB + MBoF+ MBoT)/(VBo_tot-VBoB_lv)
    Crest_bled <-  (MRB + MRF+ MRT)/(VRe_tot-VReB_lv)
    Ccarcass_bled <- (MMB+MMF+MMT+MAB+MAF+MAT+MRB+MRF+MRT+MBoB+MBoF+MBoT+MSKB+MSKF+MSKT)/(VMu_tot+VAd_tot+VRe_tot+VBo_tot+VSk_tot - 
                                                                                            VReB_lv -VBoB_lv-VSkB_lv-VAdB_lv-VMuB_lv)
...
create.inits <- function(parameters){
  with(as.list(parameters),{
    ...
    MUA <- 0; MLuAFf <- 0; MLuAFb<- 0; MLuAFdust_fast <- 0; MLuAFdust_slow <- 0; MSPTf <- 0; MHTf <- 0;  MBrTf <- 0;
...
create_all_fixed_params <- function(){
  ...
  # Set up simulations for the 27th case, i.e. Gustafsson (2022) oral male 
  ...
  admin.dose <- 2*rep((512.5*0.62*0.335)/k, length.out = k) #ug PFOA, for 22.5 min inhalation
  ...
  params[[29]] <- create_fixed_params(user_input)
  ...
  user_input <- list('BW'=BW,
                     ...
                     "admin.type" = admin.type,
                     "sex" = sex, "depfr_head" = depfr_head, "depfr_AF" = depfr_AF)
  params[[30]] <- create_fixed_params(user_input) 
  ...
  user_input <- list('BW'=BW,
                     ...
                     "admin.type" = admin.type,
                     "sex" = sex, "depfr_head" = depfr_head, "depfr_AF" = depfr_AF ) 
  params[[31]] <- create_fixed_params(user_input)
  ...
  user_input <- list('BW'=BW,
                     ...
                     "admin.type" = admin.type,
                     "sex" = sex, "depfr_head" = depfr_head, "depfr_AF" = depfr_AF )
  params[[32]] <- create_fixed_params(user_input)
  ...
  user_input <- list('BW'=BW,
                     ...
                     "admin.type" = admin.type,
                     "sex" = sex, "depfr_head" = depfr_head, "depfr_AF" = depfr_AF )
  params[[33]] <- create_fixed_params(user_input) 
  ...
  user_input <- list('BW'=BW,
                     ...
                     "admin.type" = admin.type,
                     "sex" = sex, "depfr_head" = depfr_head, "depfr_AF" = depfr_AF )
  params[[34]] <- create_fixed_params(user_input) 
...
obj.func <- function(x, dataset, fixed_params){
  ...
  score <- rep(NA, N_data)
  N_points <- rep(NA, N_data)
  
  BW <- 0.29  # body weight (kg)
  sex <- "M" 
  variable_params <- create_variable_params(x,BW, sex, fixed_params[[1]])
  ...
  N_points[1] <-   sum(unlist(lapply( obs_kudo_high,length)))
  ...
  BW <- 0.29  # body weight (kg)
  sex <- "M" 
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[2]])
  ...
  N_points[2] <-   sum(unlist(lapply( obs_kudo_low,length)))
  ...
  # Set up simulations for the 3rd case, i.e. kim (2016) IV male tissues
  BW <- 0.25 #kg, from Kim et al. 2018
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[3]])
  ...
  N_points[3] <-   sum(unlist(lapply( obs_kim_IV_Mtissues,length)))
  ...
  BW <- 0.25 #kg, from Kim et al. 2018
  sex <- "M" 
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[4]])
  ...
  N_points[4] <-   sum(unlist(lapply( obs_kim_OR_Mtissues,length)))
  ...
  BW <- 0.25 #kg, from Kim et al. 2018
  sex <- "F" 
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[5]])
  ...
  N_points[5] <-   sum(unlist(lapply( obs_kim_IV_Ftissues,length)))
  ...
  BW <- 0.25 #kg, from Kim et al. 2018
  sex <- "F" 
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[6]])
  ...
  N_points[6] <-   sum(unlist(lapply( obs_kim_OR_Ftissues,length)))
  ...
  BW <- 0.3  # body weight (kg) not reported, based on 8 week male rats from https://animal.ncku.edu.tw/p/412-1130-16363.php?Lang=en
  sex <- "M" 
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[7]])
  ...
  N_points[7] <-   sum(unlist(lapply( obs_dzi_OR_Mtissues,length)))
  ...
  BW <- 0.2  # body weight (kg) not reported, # body weight (kg) not reported, based on 8 week female rats from https://animal.ncku.edu.tw/p/412-1130-16363.php?Lang=en
  sex <- "F" 
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[8]])
  ...
  N_points[8] <-   sum(unlist(lapply( obs_dzi_OR_Ftissues,length)))
  ...
  BW <- 0.25  #kg, from Kim et al. 2018
  sex <- "M" 
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[9]])
  ...
  N_points[9] <-   sum(unlist(lapply( obs_kim_OR_Mblood,length)))
  ...
  BW <- 0.25 #kg, from Kim et al. 2018
  sex <- "M" 
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[10]])
  ...
  N_points[10] <-   sum(unlist(lapply( obs_kim_IV_Mblood,length)))
  ...
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[11]])
  ...
  N_points[11] <-   length( obs_Kemp_OR_Furine_low)
  ...
  N_points[12] <-   length( obs_Kemp_OR_Ffeces_low)
  
  
  # Set up simulations for the 12th case, i.e.Kemper 2003 (Worley) ORAL female  MEDIUM
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[12]])
  ...
  N_points[13] <-   length( obs_Kemp_OR_Furine_med)
  ...
  N_points[14] <-   length( obs_Kemp_OR_Ffeces_med)
  
  ##########################################################################################
  # Set up simulations for the 13ath case, i.e.Kemper 2003 (Worley) ORAL female HIGH
  sample_time <- seq(0,672,1)
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[13]])
  ...
  N_points[15] <-   length( obs_Kemp_OR_Furine_high)
  ...
  N_points[16] <-   length( obs_Kemp_OR_Ffeces_high)
  ...
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[14]])
  ...
  N_points[17] <-   length( obs_Kemp_OR_Murine_low)
  ...
  N_points[18] <-   length( obs_Kemp_OR_Mfeces_low)
  
  ####################################################################################################
  # Set up simulations for the 15th case, i.e.Kemper 2003 (Worley) ORAL male MEDIUM
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[15]])
  ...
  N_points[19] <-   length( obs_Kemp_OR_Murine_med)
  ...
  N_points[20] <-   length( obs_Kemp_OR_Mfeces_med)
  
  ######################################################################################################
  # Set up simulations for the 16th case, i.e.Kemper 2003 (Worley) ORAL male  HIGH
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[16]])
  ...
  N_points[21] <-   length( obs_Kemp_OR_Murine_high)
  ...
  N_points[22] <-   length( obs_Kemp_OR_Murine_high)
  ...
  BW <- 0.3   # body weight (kg) not reported, # body weight (kg) not reported, based on 8 week male rats from https://animal.ncku.edu.tw/p/412-1130-16363.php?Lang=en
  sex <- "M"
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[17]])
  ...
  N_points[23] <-   sum(unlist(lapply( obs_dzi_IV_Mserum,length)))
  ...
  BW <- 0.3   # body weight (kg) not reported, # body weight (kg) not reported, based on 8 week male rats from https://animal.ncku.edu.tw/p/412-1130-16363.php?Lang=en
  sex <- "M"
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[18]])
  ...
  N_points[24] <-   sum(unlist(lapply( obs_dzi_OR_Mserum_low,length)))
  ...
  BW <- 0.3   # body weight (kg) not reported, # body weight (kg) not reported, based on 8 week male rats from https://animal.ncku.edu.tw/p/412-1130-16363.php?Lang=en
  sex <- "M"
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[19]])
  ...
  N_points[25] <-   sum(unlist(lapply( obs_dzi_OR_Mserum_medium,length)))
  ...
  BW <- 0.3   # body weight (kg) not reported, # body weight (kg) not reported, based on 8 week male rats from https://animal.ncku.edu.tw/p/412-1130-16363.php?Lang=en
  sex <- "M"
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[20]])
  ...
  N_points[26] <-   sum(unlist(lapply( obs_dzi_OR_Mserum_high,length)))
  ...
  BW <- 0.2    # body weight (kg) not reported, based on 8 week female rats from https://animal.ncku.edu.tw/p/412-1130-16363.php?Lang=en
  sex <- "F"
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[21]])
  ...
  N_points[27] <-   sum(unlist(lapply( obs_dzi_IV_Fserum,length)))
  ...
  BW <- 0.2    # body weight (kg) not reported, based on 8 week female rats from https://animal.ncku.edu.tw/p/412-1130-16363.php?Lang=en
  sex <- "F"
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[22]])
  ...
  N_points[28] <-   sum(unlist(lapply( obs_dzi_OR_Fserum_low,length)))
  ...
  BW <- 0.2    # body weight (kg) not reported, based on 8 week female rats from https://animal.ncku.edu.tw/p/412-1130-16363.php?Lang=en
  sex <- "F"
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[23]])
  ...
  N_points[29] <-   sum(unlist(lapply( obs_dzi_OR_Fserum_medium,length)))
  ...
  BW <- 0.2    # body weight (kg) not reported, based on 8 week female rats from https://animal.ncku.edu.tw/p/412-1130-16363.php?Lang=en
  sex <- "F"
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[24]])
  ...
  N_points[30] <-   sum(unlist(lapply( obs_dzi_OR_Fserum_high,length)))
  ...
  BW <- 0.25  #kg, from Kim et al. 2018
  sex <- "F" 
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[25]])
  ...
  N_points[31] <-   sum(unlist(lapply( obs_kim_OR_Fblood,length)))
  ...
  BW <- 0.25 #kg, from Kim et al. 2018
  sex <- "F" 
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[26]])
  ...
  N_points[32] <-   sum(unlist(lapply( obs_kim_IV_Fblood,length)))
  ...
  BW <- 0.5125  #kg, from Gustafsson et al., 2022
  sex <- "M" 
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[27]])
  ...
  N_points[33] <-   sum(unlist(lapply( obs_gus_OR_Mblood,length)))
  ...
  # Set up simulations for the 8th case, i.e. Gustafsson (2022) Inhalation male blood
  BW <- 0.5125  #kg, from Gustafsson et al., 2022
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[28]])
  ...
  N_points[35] <-   sum(unlist(lapply( obs_gus_INH_Mblood,length)))
  ...
  N_points[36] <-   sum(unlist(lapply( obs_gus_INH_Mtissues,length)))
  ...
  BW <- (0.311+0.195)/2  #kg, https://animal.ncku.edu.tw/p/412-1130-16363.php?Lang=en
  sex = "M"
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[29]])
  ...
  N_points[37] <-   sum(unlist(lapply( obs_hind_INH_Mblood_low,length)))
  ...
  BW <- (0.311+0.195)/2  #kg, https://animal.ncku.edu.tw/p/412-1130-16363.php?Lang=en
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[30]])
  ...
  N_points[38] <-   sum(unlist(lapply( obs_hind_INH_Mblood_medium,length)))
  ...
  BW <- (0.311+0.195)/2  #kg, https://animal.ncku.edu.tw/p/412-1130-16363.php?Lang=en
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[31]])
  ...
  N_points[39] <-   sum(unlist(lapply( obs_hind_INH_Mblood_high,length)))
  ...
  BW <- (0.197+0.145)/2  #kg,  https://animal.ncku.edu.tw/p/412-1130-16363.php?Lang=en
  sex <- "F"
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[32]])
  ...
  N_points[40] <-   sum(unlist(lapply( obs_hind_INH_Fblood_low,length)))
  ...
  BW <- (0.197+0.145)/2  #kg,  https://animal.ncku.edu.tw/p/412-1130-16363.php?Lang=en
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[33]])
  ...
  N_points[41] <-   sum(unlist(lapply( obs_hind_INH_Fblood_medium,length)))
  ...
  BW <- (0.197+0.145)/2  #kg,  https://animal.ncku.edu.tw/p/412-1130-16363.php?Lang=en
  variable_params <- create_variable_params(x,BW,sex, fixed_params[[34]])
  ...
  N_points[42] <-   sum(unlist(lapply( obs_hind_INH_Fblood_high,length)))
...
##
#
setwd('/Users/eviepapakyriakopoulou/Documents/GitHub/multi-route-pbk-pfoa')
...
dataset <- list("df1" = kudo_high_dose, "df2" = kudo_low_dose, "df3" = kim_IV_Mtissues, "df4" = kim_OR_Mtissues,
                ...
                "df29" = gus_INH_Mblood,
                "df30" = gus_INH_Mtissues, "df31" = hind_INH_Mblood_low, "df32" = hind_INH_Mblood_medium,
                "df33" = hind_INH_Mblood_high,"df34" = hind_INH_Fblood_low,
                "df35" = hind_INH_Fblood_medium, "df36" = hind_INH_Fblood_high)
...
kua_res <- rep(NA,10)
counter <- 1
for (val in c(0.01, 0.05, 0.1, 0.5, 0.75,  2, 5,10, 20, 50)){
  print(counter)
  test_pars <- c(val, 1, 1)
  kua_res[counter] <- obj.func(test_pars, dataset, fixed_params)
  counter <- counter+ 1

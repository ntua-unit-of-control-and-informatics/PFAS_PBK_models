...
ode.func <- function(time, inits, params){
  with(as.list(c(inits, params)),{
    ...
    dM_excr <- k_out*CF_gill + cl_feces*M_li
    ...
    # GIT
    dM_git <- ku*M_lumen + F_git*(CF_art - CF_git/P_git)
    
    # Liver
    dM_li <- F_li*(CF_art - CF_li/P_li) + F_rp*(CF_rp/P_rp - CF_li/P_li) +
      F_git*(CF_git/P_git - CF_li/P_li) + F_go*(CF_go/P_go - CF_li/P_li) - cl_feces*M_li
...
obj.func <- function(x, compartments, compartments_last_point, params, rest, fitted_params_names){
...
Test_1 <- list("compartments" = c("Liver"),
               ...
               "rest" = F,
               "fitted_params_names" = c("P_li", "cl_feces"),
               "x0" = c(1, 0.0001),
               "lb"	= c(1e-10, 1e-10),
               "ub" = c(1e03, 1e03)
)
...
Test_3 <- list("compartments" = c("Liver"),
               "compartments_last_point" = NULL,#c("Brain", "Gill",  "Git", "Kidney", "RPT", "PPT"),
               "rest" = F,
               "fitted_params_names" = c("P_li", 'cl_feces', "CalbB"),
               "x0" = c(1, 0.0001, 0.25),
               "lb"	= c(1e-10, 1e-10, 1e-5),
               "ub" = c(1e03, 1e03, 1e03)
)
...
Test_4 <- list("compartments" = c("Liver"),
               ...
               "rest" = F,
               "fitted_params_names" = c("P_li", "P_br", "P_git", "cl_feces",
                                         "P_ki", "P_rp", "P_pp",  "CalbB"),
               "x0" = c(rep(1,7), 0.25),
               "lb"	= c(rep(1e-10, 7), 1e-05),
               "ub" = c(rep(1e03, 8))
)
...
Test_5 <- list("compartments" = c("Liver"),
               ...
               "fitted_params_names" = c("P_li", "P_br", "P_git", "cl_feces",
                                         "P_ki", "P_rp", "P_pp",  "CalbB"),
               "x0" = c(rep(1,7), 0.25),
               "lb"	= c(rep(1e-10, 7), 0.0001),
               "ub" = c(rep(1e03, 8))
)


Test_6 <- list("compartments" = c("Liver", "Git"),
               "compartments_last_point" = c("Brain", "Gill", "Kidney", "RPT", "PPT"),
               "rest" = F,
               "fitted_params_names" = c("P_li", "P_br", "P_git", "cl_feces",
                                         "P_ki", "P_rp", "P_pp",  "CalbB"),
               "x0" = c(rep(1,7), 0.25),
...
Test_7 <- list("compartments" = c("Liver", "Git"),
               "compartments_last_point" = c("Brain", "Gill", "Kidney", "RPT", "PPT"),
               "rest" = T,
               "fitted_params_names" = c("P_li", "P_br", "P_git", "cl_feces",
                                         "P_ki", "P_rp", "P_pp",  "CalbB"),
...
Test_8 <- list("compartments" = c("Liver", "Git", "Brain"),
               "compartments_last_point" = c("Gill", "Kidney", "RPT", "PPT"),
               "rest" = F,
               "fitted_params_names" = c("P_li", "P_br", "P_git", "cl_feces",
                                         "P_ki", "P_rp", "P_pp",  "CalbB"),
               "x0" = c(rep(1,7), 0.25),
...
Test_9 <- list("compartments" = c("Liver", "Git", "Brain"),
               "compartments_last_point" = c("Gill", "Kidney", "RPT", "PPT"),
               "rest" = T,
               "fitted_params_names" = c("P_li", "P_br", "P_git", "cl_feces",
                                         "P_ki", "P_rp", "P_pp",  "CalbB"),
...
Test_10 <- list("compartments" = c("Liver", "Git", "Gill"),
               "compartments_last_point" = c("Brain", "Kidney", "RPT", "PPT"),
               "rest" = F,
               "fitted_params_names" = c("P_li", "P_br", "P_git", "cl_feces",
                                         "P_ki", "P_rp", "P_pp",  "CalbB"),
               "x0" = c(rep(1,7), 0.25),
...
Test_11 <- list("compartments" = c("Liver", "Git", "Gill"),
                "compartments_last_point" = c("Brain", "Kidney", "RPT", "PPT"),
                "rest" = T,
                "fitted_params_names" = c("P_li", "P_br", "P_git", "cl_feces",
                                          "P_ki", "P_rp", "P_pp",  "CalbB"),
...
Test_12 <- list("compartments" = c("Liver", "Git", "Gill", "PPT"),
               "compartments_last_point" = c("Brain",  "Kidney", "RPT"),
               "rest" = F,
               "fitted_params_names" = c("P_li", "P_br", "P_git", "cl_feces",
                                         "P_ki", "P_rp", "P_pp",  "CalbB"),
               "x0" = c(rep(1,7), 0.25),
...
Test_13 <- list("compartments" = c("Liver", "Git", "Gill", "PPT"),
                "compartments_last_point" = c("Brain",  "Kidney", "RPT"),
                "rest" = T,
                "fitted_params_names" = c("P_li", "P_br", "P_git", "cl_feces",
                                          "P_ki", "P_rp", "P_pp",  "CalbB"),
...
Tests_list <-list(Test_1, Test_2, Test_3, Test_4, Test_5, Test_6, Test_7, Test_8,
...
for (i in 1:length(Tests_list)) {
  ...
  ggsave(paste0("Results/Train/", "Test_", i, "_Train.png" ), Test$Plots$Training_plot, width = 12, height = 8, units = "in")
  ggsave(paste0("Results/Validation/", "Test_", i, "_Validation.png" ), Test$Plots$Validation_plot, width = 12, height = 8, units = "in")
}

...
input_nasal_specific <-   c("kabsUA", "kCLEua",  "kCLEal")

output_all <- c( 'Cplasma'=Cplasma, 'Ckidney'=Ckidney, 'Cliver'=Cliver,  'Cstomach'=Cstomach, 
                 'Cintestine'=Cintestine, 'Cmuscle'=Cmuscle, 'Cadipose'=Cadipose,
                 'Clungs'=Clungs,  'Crest'=Crest, 'Cspleen'=Cspleen, 'Cheart'=Cheart, 'Cbrain'=Cbrain, 
                 'Mbrain'=Mbrain, 'Cgonads'=Cgonads, 'Cskin'=Cskin, 'Cbones'=Cbones,
                 'Mfeces'=dMfeces, 'Curine'=dMurine,)
output_inhalation_specific <- c('CalveolarLF'=CalveolarLF)
output_nasal_specific <- c('CalveolarLF'=CalveolarLF, 'CUpperair'=CUpperair)
...
#---------------------------------------
#    Case 4: Female, oral, medium dose
#--------------------------------------
BW <- 0.3  # body weight (kg)
admin.dose_per_g <- 1 # administered dose in mg PFOA/kg BW 
admin.dose <- admin.dose_per_g*BW*1e03 #ug PFOA

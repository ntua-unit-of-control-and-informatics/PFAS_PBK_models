...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/protein_binding/non_specific_binding_ka_74_fprotein_unity_common_RAFBile_different_RAFLiver")
...
estimated_params <- exp(optimizer$solution)
save.image("non_specific_binding_ka_74_fprotein_unity_common_RAFBile_different_RAFLiver.RData")

...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_Bladder/Training/AAFE/No_Papp_No_Ka2")
...
lb = c(rep(log(1e-20), 10), rep(log(0.01),2), log(0.1))
ub = c(rep(log(1e10), 10), rep(log(10),2), log(1) )
...
estimated_params <- exp(optimizer$solution)
save.image("No_Papp_No_Ka2.RData")

...
create.params <- function(user.input){
  with(as.list(user.input),{
    ...
    Qfeces <- ((8.18/0.21)*BW/1000)/24 #g/kg BW, based on Cui et al.(2010)
...
ode.func <- function(time, inits, params){
  with(as.list(c(inits, params)),{
    ...
    'CKTf'=CKTf, 'CKTb'=CKTb, 'CFil'=CFil, "CPT" = CPT, 'CBladder' = CBladder, 'CLB'=CLB, 'CLBf'=CLBf, 'CLBb'=CLBb, 
...
setwd("C:/Users/ptsir/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_Bladder/Training/AAFE/full_params_PT_excreta_restricted_Ka_58_no_papp.RData")
...
lb = c(rep(log(1e-3), 4),rep(log(1e-20), 2),rep(log(1e-3), 3), rep(log(0.1),2) )
ub = c(rep(log(1e3), 4),rep(log(1e7), 2), rep(log(1e3), 3),  rep(log(10),2))
...
estimated_params <- exp(optimizer$solution)
save.image("full_params_PT_excreta_restricted_Ka_58_no_papp.RData")

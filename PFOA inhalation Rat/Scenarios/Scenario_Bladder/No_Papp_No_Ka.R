...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_Bladder/Training/AAFE/No_Papp_No_Ka")
...
estimated_params <- exp(optimizer$solution)
save.image("No_Papp_No_Ka.RData")

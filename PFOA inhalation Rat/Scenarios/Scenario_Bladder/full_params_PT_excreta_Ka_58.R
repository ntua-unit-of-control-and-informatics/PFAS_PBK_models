...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_Bladder/Training/AAFE/full_params_PT_excreta_Ka_58")
...
estimated_params <- exp(optimizer$solution)
save.image("full_params_PT_excreta_Ka_58.RData")

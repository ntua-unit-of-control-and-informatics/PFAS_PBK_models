...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_Bladder/Training/AAFE/no_bile_ka_58e5_weight_0")
...
estimated_params <- exp(optimizer$solution)
save.image("no_bile_ka_58e5_weight_0.RData")

...
setwd("C:/Users/ptsir/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_Bladder/Training/AAFE/few_params_PT_excreta_restricted")
...
lb = c(rep(log(1e-3), 4),rep(log(1e-20), 2),rep(log(1e-3), 3),  log(5e4))
ub = c(rep(log(1e3), 4),rep(log(1e7), 2), rep(log(1e3), 3),  log(6e5) )
...
estimated_params <- exp(optimizer$solution)
save.image("few_params_PT_excreta_restricted.RData")

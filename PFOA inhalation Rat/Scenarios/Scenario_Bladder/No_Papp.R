...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_Bladder/Training/AAFE/No_Papp")
...
lb = c(rep(log(1e-20), 10), rep(log(0.1),3),  log(1e4))
ub = c(rep(log(1e7), 10), rep(log(2),3),  log(1e6) )

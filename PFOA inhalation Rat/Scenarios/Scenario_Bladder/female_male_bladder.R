...
create.params <- function(user.input){
  with(as.list(user.input),{
    ...
    Ka <-estimated_params[9] # 5.8e05 from Rue et al. (2024)#mol/L
...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_Bladder/Training/AAFE/female_male_bladder")
...
lb = c(rep(log(1e-20), 5),log(1e-3), rep(log(0.01),2), log(1e4))
ub = c(rep(log(1e6), 5),log(1e3), rep(log(10),2) ,log(1e6))
...
save.image("female_male_bladder.RData")

...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_Bladder/Training/AAFE/no_bile_ka_7e4_weight_10")
...
estimated_params <- exp(optimizer$solution)
save.image("no_bile_ka_7e4_weight_10.RData")

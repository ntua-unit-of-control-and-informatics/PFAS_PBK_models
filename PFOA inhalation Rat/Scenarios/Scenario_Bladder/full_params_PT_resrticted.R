...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_Bladder/Training/AAFE/full_params_PT_restricted")
...
lb = c(rep(log(1e-10), 10), log(0.1),rep(log(0.1),2),  log(5e4))
ub = c(rep(log(1e7), 10),log(10), rep(log(5),2),  log(5e5) )
...
estimated_params <- exp(optimizer$solution)
save.image("full_params_PT_restricted.RData")

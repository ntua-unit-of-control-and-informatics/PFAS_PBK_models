...
setwd("C:/Users/ptsir/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_Bladder/Training/AAFE/full_params_PT_excreta_restricted_Ka_58.RData")
...
lb = c(rep(log(1e-3), 4),rep(log(1e-20), 2),rep(log(1e-3), 3), rep(log(0.1),3) )
ub = c(rep(log(1e3), 4),rep(log(1e7), 2), rep(log(1e3), 3),  rep(log(10),3))
...
estimated_params <- exp(optimizer$solution)
save.image("full_params_PT_excreta_restricted_Ka_58.RData")

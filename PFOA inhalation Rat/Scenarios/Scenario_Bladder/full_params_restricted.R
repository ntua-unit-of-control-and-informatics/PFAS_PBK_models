...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_Bladder/Training/AAFE/full_params_restricted")
...
lb = c(rep(log(1e-3), 10), log(0.1), rep(log(0.1),3),  log(1e4))
ub = c(rep(log(1e3), 10), log(10),rep(log(2),3),  log(1e6) )
...
estimated_params <- exp(optimizer$solution)
save.image("full_params_restricted.RData")

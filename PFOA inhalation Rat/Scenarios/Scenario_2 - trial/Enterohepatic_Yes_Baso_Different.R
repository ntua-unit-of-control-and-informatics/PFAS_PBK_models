...
setwd("C:/Users/dpjio/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_2 - trial/Training/AAFE")
...
fit <-  c(rep(log(1), 3),log(1e3),log(1e3),log(0.001), log(1), log(0.1),log(1e3),log(1e3),log(1e2),log(1))

lb	= c(rep(log(1e-2), 3),log(1e3),log(1e3),log(1e-04), log(1e-2),log(1e-2),log(1e3),log(1e3),log(1e-2),log(1e-5))
ub = c(rep(log(1e2), 3), log(1e5),log(1e5),log(1e2),log(1e2),log(1e1),log(1e5),log(1e5),log(1e2),log(1e8))

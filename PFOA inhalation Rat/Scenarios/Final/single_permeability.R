...
create_variable_params <- function(BW,sex,  estimated_params, fixed_params){
  ...
  Pgap_continuous <-  Peff_monolayer #, cm/s, permeability by diffusion through tight junctions in continuous capillary types
...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Final/single_permeability")
...
lb = c(rep(log(1e-7),3), log(1e-3), log(1e-1), log(1e-4),  log(1e4),  log(5e3), log(1e-6),log(1e-2),log(5e-3),log(5e-3),log(1e-6),log(1e-6))
ub = c(rep(log(1e5),  3),log(1e3),  log(2e1), log(1e2),log(1e8), log(1e6) ,  log(1e-3),log(5),log(5),log(5),log(100),log(100))
...
estimated_params <- exp(optimizer$solution)
save.image("single_permeability.RData")

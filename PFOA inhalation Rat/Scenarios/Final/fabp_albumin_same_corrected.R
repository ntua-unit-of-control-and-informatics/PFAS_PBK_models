...
fit <- log(c(2.954770e+01, 4.671862e-06, 2.445784e+03, 7.204430e+01, 4.159460e+00, 
             ...
             2.762506e+04, 5.890322e-05, 7.580181e-01, 5.138487e-02,1))

lb = c(rep(log(1e-7),3), log(1e-3), log(1e-1), log(1e-4), rep(log(Papp_RYU/10),1), log(1e4),  log(5e3), log(1e-6),log(1e-2),log(5e-3),log(1e-6))
ub = c(rep(log(1e5),  3),log(1e3),  log(2e1), log(1e2), rep(log(Papp_Kimura),1),log(1e7), log(1e6) ,  log(1e-3),log(5),log(5),log(100))
...
estimated_params <- exp(optimizer$solution)
save.image("fabp_albumin_same_corrected.RData")

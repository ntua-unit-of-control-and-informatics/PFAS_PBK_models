...
create_variable_params <- function(BW,sex,  estimated_params, fixed_params){
  ...
  Pgap_continuous <- estimated_params[3] #, cm/s, permeability by diffusion through tight junctions in continuous capillary types
...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Final/only_pgap")
...
Papp_RYU =1.46e-6 # cm/h, at pH = 7.4 from Ryu et al. (2024) [https://doi.org/10.1016/j.chemosphere.2024.142390]
...
fit <- log(c(0.1,0.01, 1e-5 ))

lb = log(c(1e-6,1e-6,1e-7 ))
ub = log(c(100,100, 1e-3 ))

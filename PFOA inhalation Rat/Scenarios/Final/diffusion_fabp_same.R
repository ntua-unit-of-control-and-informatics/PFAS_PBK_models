...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Final/diffusion_fabp_same")
...
fit <- log(c(3.853823e+01, 4.113336e-05, 5.238279e+03, 7.352394e+01, 3.607135e+00, 
             ...
             3.655316e+04, 9.651647e-05, 1.027851e+00, 2.319324e-01, 1, 4.619474e-04))



lb = c(rep(log(1e-7),3), log(1e-3), log(1e-1), log(1e-4), log(1e-6), log(1e4),  log(5e3), log(1e-6),log(1e-2),log(5e-3),log(1e-6),log(1e-6))
ub = c(rep(log(1e5),  3),log(1e3),  log(2e1), log(1e2),  log(0.01),log(1e7), log(1e6) ,  log(1e-3),log(5),log(5),log(100),log(100))
...
estimated_params <- exp(optimizer$solution)
save.image("diffusion_fabp_same.RData")

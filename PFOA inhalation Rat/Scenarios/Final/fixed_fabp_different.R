...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Final/fixed_fabp_different")
...
fit <- log(c(3.421976e+01, 2.361523e-06, 1.118783e+04, 1.929577e+02, 5.632397e+00, 2.739665e+00,
             1e-05,  4.581313e-05, 3.184580e+00, 1.119164e-01, 2.633966e-02, 1))
...
estimated_params <- exp(optimizer$solution)
save.image("fixed_fabp_different.RData")

...
fit <- log(c(4.303204e+01,1.701470e-06,8.541510e+03,1.091045e+02,3.591703e+00,1.829126e+00,7.936052e-04,1.441703e+07,
              1.527742e+04,7.363177e-05,2.670960e+00,1.119162e-01,5.844764e-02,1e-3))
...
estimated_params <- exp(optimizer$solution)
save.image("fabp_different_corrected_newoa.RData")

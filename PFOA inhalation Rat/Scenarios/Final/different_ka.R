...
create_variable_params <- function(BW,sex,  estimated_params, fixed_params){
  ...
  if(sex == "M"){
    Ka <- estimated_params[10]
    VmK_api <- 0
    f_fabp_avail  <-estimated_params[12]
    
  }else{
    Ka <- estimated_params[11]
  ...
  Pgap_continuous <-  estimated_params[6] #, cm/s, permeability by diffusion through tight junctions in continuous capillary types
  ...
  KmK_baso <- 1e20
  KmK_api <-   5e4
  KLfabp <-  estimated_params[7]#(1.2e5+4e4+1.9e4) #[L/mol]*1e-3 , value from Cheng et al. (2017)
  # 7e4 # from Rue et al. (2024)#mol/L
...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Final/different_ka")
...
fit <- log(c(3.421976e+01, 1.118783e+04, 1.929577e+02, 5.632397e+00, 2.739665e+00,
             1e-05, 3.224089e+07,
             4.581313e-05, 3.184580e+00,1.792674e+04, 1.792674e+04,  1.119164e-01, 2.633966e-02, 1.743394e+00,1))

lb = c(rep(log(1e-7),2), log(1e-3), log(1e-1), log(1e-4), rep(log(Papp_RYU/10),1), log(1e4), log(1e-6), log(5e3), log(5e3), log(1e-2),log(5e-3),log(5e-3),log(1e-6),log(1e-6))
ub = c(rep(log(1e5), 2),log(1e3),  log(2e1), log(1e2), rep(log(Papp_Kimura),1),log(1e8), log(1e-3),log(1e6) , log(1e6) , log(5),log(5),log(5),log(100),log(100))

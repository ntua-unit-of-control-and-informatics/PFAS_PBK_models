...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Final/fixed_albumin_different")
...
fit <- log(c(1.134802e+01, 9.615959e-07, 4.376660e+03, 8.327408e+01, 8.840910e+00,
             3.969017e+00, 5.284264e-05,  8.052728e-05, 2.008991e-01, 2.541547e+00, 5.895794e-01, 5.620507e-01))

lb = c(rep(log(1e-7),3), log(1e-3), log(1e-1), log(1e-4), rep(log(Papp_RYU/10),1),  log(1e-6),log(1e-2),log(5e-3),log(5e-3),log(1e-6))
ub = c(rep(log(1e5),  3),log(1e3),  log(2e1), log(1e2), rep(log(Papp_Kimura),1),  log(1e-3),log(5),log(5),log(5),log(100))
...
estimated_params <- exp(optimizer$solution)
save.image("fixed_albumin_different.RData")

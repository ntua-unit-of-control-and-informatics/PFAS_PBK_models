...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Publication/Ka_albumin_fixed/favail_fixed/reduction_fixed/reduction_0.005")
...
fit <- log(c(1.8e+01, 1e-03, 1e3, 0.02, 1, 1, 1e-4))
...
estimated_params <- exp(optimizer$solution)
save.image("ka_fixed_favail_fixed_reduction_fixed_0.005.RData")

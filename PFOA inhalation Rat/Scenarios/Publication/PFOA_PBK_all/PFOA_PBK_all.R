...
create_variable_params <- function(BW,sex,  estimated_params, fixed_params){
  ...
  KmK_baso <- 1e20
  KmK_api <-   5e4
  KLfabp <- estimated_params[12] #[L/mol], from Sheng et al. 2018
  Ka <- estimated_params[13]# from Rue et al. (2024)#mol/L
  ...
  f_alb_avail<-  estimated_params[7]
...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Publication/PFOA_PBK_all")
...
fit <- log(c(1.8e+01, 1e-04, 1e+03, 1e+01, 3.0e+00, 1e+00, 0.5, 0.5, 1e-4, 1, 1e-2, 1e5, 1e5 ))

# lb = log(c(1e-2, 1e-8,1e-1, 1e0, 1e-1, 1e-1, 1e-6,1e-2, 1e-2,1e-2, 1e-1, 5e-4, 1e-3))
# ub = log(c(5e1, 1e-2, 1e4,  3e2,  2e1,  1e1, 1e-3, 0.5,  0.7, 0.5, 4, 1e-1,  3e-1))

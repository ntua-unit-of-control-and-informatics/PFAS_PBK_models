...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Publication/PFOA_PBK_fabp")
...
fit <- log(c(1.8e+01, 1e-04, 1e+03, 1e+01, 3.0e+00, 1e+00, 0.5, 0.5, 1e-4, 1, 1e-2 ))
...
estimated_params <- exp(optimizer$solution)
save.image("PFOA_PBK_fabp.RData")

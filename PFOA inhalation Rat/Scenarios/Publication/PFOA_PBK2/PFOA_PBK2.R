...
create_variable_params <- function(BW,sex,  estimated_params, fixed_params){
  ...
  Ka <- estimated_params[8]#5.8e5[L/mol]. From Rue et al. (2024)
  ...
  koff_fabp <-  koff_alb #estimated_params[12]
  koff_a2u <- koff_alb
...
fit <- log(c(1.8e+01, 1e-04, 1e+03, 1e+01, 3.0e+00, 1e+00, 1e5, 1e5, 1e-4))

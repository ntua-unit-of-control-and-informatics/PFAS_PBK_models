...
create_variable_params <- function(BW,sex,  estimated_params, fixed_params){
  ...
  KLfabp <- estimated_params[8]#1.2e5 #[L/mol]. From Sheng et al. 2018
  Ka <- estimated_params[9]#5.8e5#[L/mol]. From Rue et al. (2024)
...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Publication/Ka_Kfabp_estimated/favail_fixed/reduction_fixed/reduction_0.005")
...
fit <- log(c(1.8e+01, 1e-03, 1e3, 0.02, 1, 1, 1e-4, 1e5, 1e5))
...
estimated_params <- exp(optimizer$solution)
save.image("ka_kfabp_estimated_fixed_favail_fixed_reduction_fixed_0.005.RData")

...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Publication/Ka_Kfabp_estimated/favail_fixed/reduction_fixed/reduction_0.1")
...
estimated_params <- exp(optimizer$solution)
save.image("ka_kfabp_estimated_fixed_favail_fixed_reduction_fixed_0.1.RData")

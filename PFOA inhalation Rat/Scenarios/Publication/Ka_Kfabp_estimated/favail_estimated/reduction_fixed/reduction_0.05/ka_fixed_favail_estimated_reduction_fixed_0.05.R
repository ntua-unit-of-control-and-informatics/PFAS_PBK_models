...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Publication/Ka_albumin_fixed/favail_estimated/reduction_fixed/reduction_0.05")
...
estimated_params <- exp(optimizer$solution)
save.image("ka_fixed_favail_estimated_reduction_fixed_0.05.RData")

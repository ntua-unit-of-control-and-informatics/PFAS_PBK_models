...
create_variable_params <- function(BW,sex,  estimated_params, fixed_params){
  ...
  KLfabp <-  estimated_params[9]#[L/mol]. From Sheng et al. 2018
...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Publication/Ka_Kfabp_estimated/favail_estimated/reduction_estimated")
...
fit <- log(c(1.8e+01, 1e-03, 1e3, 0.02, 1, 1, 1e-4,  0.1, 1e5, 1e5, 1, 1))
...
estimated_params <- exp(optimizer$solution)
save.image("ka_kfabp_estimated_favail_estimated_reduction_estimated.RData")

...
create_variable_params <- function(BW,sex,  estimated_params, fixed_params){
  ...
  k1 <- estimated_params[3]
  k2 <- estimated_params[4]
...
ode.func <- function(time, inits, params){
  ...
  with(as.list(c(inits, params)),{
    ...
    #Lung tissue
    dMLuTf =  - kLuTLuF*(CLuTf-CLuFf) -  kLuTLuAF*(k1*CLuTf-k2*CLuAFf) + (VmLu_Oatp_bas*CLuFf/(KmLu_Oatp_bas+CLuFf)) +
      (VmLu_Oatp_ap*CLuAFf/(KmLu_Oatp_ap+CLuAFf)) 
    #Alveolar lining fluid
    dMLuAFf =  k_desorption * CLuAFdust + kLuTLuAF*(k1*CLuTf-k2*CLuAFf) + 
...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Publication/Final_Inhalation_model/favail_fixed_kabs")
...
save.image("favail_fixed_kabs.RData")

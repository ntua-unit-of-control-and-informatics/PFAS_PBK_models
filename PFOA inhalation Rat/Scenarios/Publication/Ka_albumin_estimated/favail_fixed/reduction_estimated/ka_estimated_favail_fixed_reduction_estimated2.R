...
create_variable_params <- function(BW,sex,  estimated_params, fixed_params){
  ...
  Ka <- estimated_params[10]#[L/mol]. From Rue et al. (2024)
  ...
  reduction_factor <- estimated_params[9]
...
obj.func <- function(x, dataset, fixed_params){
  ...
  dzirlenga_female_liver_multiplier <- 5
  kim_multiplier <- 3
  ##########################
  #-------------------------
  # Kudo high
  ...
  score[9] <- kim_multiplier*N_kim_OR_Mblood*AAFE(predictions = preds_kim_OR_Mblood, observations = obs_kim_OR_Mblood)  
  N_points <- N_points + kim_multiplier*N_kim_OR_Mblood  
  ...
  score[10] <- kim_multiplier*N_kim_IV_Mblood*AAFE(predictions = preds_kim_IV_Mblood, observations = obs_kim_IV_Mblood)  
  N_points <- N_points + kim_multiplier*N_kim_IV_Mblood 
  ...
  score[31]       <- kim_multiplier*N_kim_OR_Fblood * AAFE(preds_kim_OR_Fblood, obs_kim_OR_Fblood)
  N_points        <- N_points + kim_multiplier*N_kim_OR_Fblood
  ...
  score[32]       <- kim_multiplier*N_kim_IV_Fblood * AAFE(preds_kim_IV_Fblood, obs_kim_IV_Fblood)
  N_points        <- N_points + kim_multiplier*N_kim_IV_Fblood
...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Publication/Ka_albumin_estimated/favail_fixed/reduction_estimated")
...
fit <- log(c(4.860636e+01, 5.155401e-03, 7.829831e+03, 2.215400e-01, 6.782369e+00,
             4.442358e-01,1e-05, 6.330274e-05,
             3.169046e-02, 2.255763e+04))
...
estimated_params <- exp(optimizer$solution)
save.image("ka_estimated_favail_fixed_reduction_estimated2.RData")

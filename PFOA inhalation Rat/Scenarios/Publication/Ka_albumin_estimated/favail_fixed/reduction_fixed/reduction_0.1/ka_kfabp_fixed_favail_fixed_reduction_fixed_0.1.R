...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Publication/Ka_albumin_fixed/favail_fixed/reduction_fixed/reduction_0.1")

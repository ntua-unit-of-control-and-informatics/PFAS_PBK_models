...
create_variable_params <- function(BW,sex,  estimated_params, fixed_params){
  ...
  KLfabp <- estimated_params[8] #[L/mol]. From Sheng et al. 2018
...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Publication/Ka_Kfabp_estimated/favail_fixed/reduction_fixed/reduction_0.01")
...
estimated_params <- exp(optimizer$solution)
save.image("ka_kfabp_estimated_favail_fixed_reduction_fixed_0.01.RData")

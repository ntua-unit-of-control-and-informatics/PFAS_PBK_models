...
create_variable_params <- function(BW,sex,  estimated_params, fixed_params){
  ...
  IPR_correction <- estimated_params[12]
  ...
  IPR_K = 0.5*IPR_correction
  IPR_L = 0.5*IPR_correction
  IPR_ST = 0.9*IPR_correction #same as gut
  IPR_IN = 0.9*IPR_correction #same as gut
  IPR_M = 0.6*IPR_correction
  IPR_A = 0.5*IPR_correction
  IPR_Lu = 0.5*IPR_correction
  IPR_Sp = 0.5*IPR_correction
  IPR_H = 0.5*IPR_correction
  IPR_SK = 1.0*IPR_correction
  IPR_Br = 0.5*IPR_correction
  IPR_Go = 0.5*IPR_correction #assumption
  IPR_Bo = 1.0*IPR_correction 
  IPR_R = 0.5*IPR_correction # assumption
...
estimated_params <- exp(optimizer$solution)
save.image("ka_estimated_favail_estimated_reduction_estimated_ipr_corrected.RData")

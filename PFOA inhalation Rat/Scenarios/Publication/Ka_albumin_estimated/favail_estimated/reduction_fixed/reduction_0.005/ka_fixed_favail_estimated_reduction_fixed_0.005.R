...
create_variable_params <- function(BW,sex,  estimated_params, fixed_params){
  ...
  kon_alb <- Ka * koff_alb #s/M
  kon_a2u <- Ka2u * koff_a2u#s/M
  kon_fabp <- KLfabp * koff_fabp #s/M
...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Publication/Ka_albumin_fixed/favail_estimated/reduction_fixed/reduction_0.005")
...
estimated_params <- exp(optimizer$solution)
save.image("ka_fixed_favail_estimated_reduction_fixed_0.005.RData")

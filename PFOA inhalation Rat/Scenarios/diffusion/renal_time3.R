...
create_variable_params <- function(BW,sex,  estimated_params, fixed_params){
  ...
  frac_a <- 1.1^log(estimated_params[11])
...
fit <- c(rep(log(1),6), rep(log(mean(c(Papp_Kimura,Papp_RYU))),1),log(0.8), log(1),log(1e-3), log(1e-1, base = 1.1))

lb = c(rep(log(1e-8),2), log(1e-5), log(1e-3),rep(log(1e-8),2),  rep(log(Papp_RYU),1), log(1e-1), log(1e-3), log(1e-5), log(1e-4, base = 1.1))
ub = c(rep(log(1e8),  2),log(1e5),  log(1e3),rep(log(1e8),  2), rep(log(Papp_Kimura),1),log(1),log(2),  log(1e2), log(1e1, base = 1.1))

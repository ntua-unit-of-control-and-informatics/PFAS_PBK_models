...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/NEW/Training/AAFE/koff_estimated")
...
fit <-  c(rep(log(1),7), rep(log(0.8),2),     log(1),log(1e-2))

lb    = c(rep(log(1e-10), 7),rep(log(0.001),2),log(1e-3), log(1e-4))
ub = c(rep(log(1e10), 7), rep(log(1),2),  log(1e3),log(1e2))
...
estimated_params <- exp(optimizer$solution)
save.image("koff_estimated.RData")

...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/NEW/Training/AAFE/koff_07_koff_fabp")
...
fit <-  c(rep(log(1),7), log(1),log(1e5),log(1e-1))

lb    = c(rep(log(1e-10), 7),log(1e-3), log(1e3), log(1e-3))
ub = c(rep(log(1e10), 7),  log(1e3),log(1e6) ,log(1e0))
...
estimated_params <- exp(optimizer$solution)
save.image("koff_07_koff_fabp.RData")

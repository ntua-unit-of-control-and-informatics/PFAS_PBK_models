...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/NEW/Training/AAFE/koff_12_lung_different_RAF_bile")
...
estimated_params <- exp(optimizer$solution)
save.image("koff_12_lung_different_RAF_bile.RData")

...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/NEW/Training/AAFE/koff_07_lung_same_RAF_restricted")
...
lb    = c(rep(log(1e-3), 8),log(1e-3), log(1e3))
ub = c(rep(log(1e3), 8),  log(1e3),log(1e6))
...
estimated_params <- exp(optimizer$solution)
save.image("koff_07_lung_same_RAF_restricted.RData")

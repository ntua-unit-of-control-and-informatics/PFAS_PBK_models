...
setwd("C:/Users/dpjio/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/NEW/Training/AAFE/koff_07_lung_dif_RAF")
...
lb    = c(rep(log(1e-10), 9),log(1e-3), log(1e3))
ub = c(rep(log(1e10), 9),  log(1e3),log(1e6))
...
estimated_params <- exp(optimizer$solution)
save.image("koff_07_lung_dif_RAF.RData")

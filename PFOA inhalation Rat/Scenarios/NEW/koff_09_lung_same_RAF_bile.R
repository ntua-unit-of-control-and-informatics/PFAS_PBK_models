...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/NEW/Training/AAFE/koff_09_lung_same_RAF_bile")
...
lb = c(rep(log(1e-20), 8), log(1e3))
ub = c(rep(log(1e6), 8), log(1e6))
...
estimated_params <- exp(optimizer$solution)
save.image("koff_09_lung_same_RAF_bile.RData")

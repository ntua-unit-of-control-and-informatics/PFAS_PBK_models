...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/NEW/Training/AAFE/koff_02_same_oatp_l")
...
fit <-  c(rep(log(1),6), log(1),log(1e5))

lb    = c(rep(log(1e-10), 6),log(1e-3), log(1e3))
ub = c(rep(log(1e10), 6),  log(1e3),log(1e6))
...
estimated_params <- exp(optimizer$solution)
save.image("koff_02_same_oatp_l.RData")

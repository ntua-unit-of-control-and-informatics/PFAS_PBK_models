...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/NEW/Training/AAFE/koff_range")
...
lb    = c(rep(log(1e-10), 7),log(1e-3), log(1e3), log(1e-1))
ub = c(rep(log(1e10), 7),  log(1e3),log(1e6) ,log(7e-1))

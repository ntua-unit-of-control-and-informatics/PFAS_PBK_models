...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/NEW/Training/AAFE/koff_07_lung_different_RAF_bile_02-10")
...
lb = c(rep(log(1e-20), 9), log(1e3))
ub = c(rep(log(1e6), 9), log(1e6))
...
estimated_params <- exp(optimizer$solution)
save.image("koff_07_lung_different_RAF_bile_02-10.RData")

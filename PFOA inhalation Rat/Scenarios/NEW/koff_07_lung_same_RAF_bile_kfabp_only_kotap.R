...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/NEW/Training/AAFE/koff_07_lung_same_RAF_bile_kfabp_only_kotap")
...
estimated_params <- exp(optimizer$solution)
save.image("koff_07_lung_same_RAF_bile_kfabp_only_kotap.RData")

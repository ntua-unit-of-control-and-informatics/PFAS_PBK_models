...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/NEW/Training/AAFE/koff_07_lung_same_RAF_bile_kfabp_kotap_oat1_koff")
...
fit <-  c(rep(log(1),7), log(1e5), log(1e5), log(0.3))

lb = c(rep(log(1e-10), 7), log(5e4), log(1e3), log(0.1))
ub = c(rep(log(1e10), 7), log(1e6), log(1e6),log(1))
...
estimated_params <- exp(optimizer$solution)
save.image("koff_07_lung_same_RAF_bile_kfabp_kotap_oat1_koff.RData")

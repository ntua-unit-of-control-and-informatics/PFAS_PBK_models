...
create.params <- function(user.input){
  with(as.list(user.input),{
    ...
    RAFOatp_k <-  1e-20#5.232517e-14
    RAFOat1 <- 1e5
    RAFOatp_l <-  0#1.313848e-08
    
    
    RAFOat3 <- RAFOat1
    RAFUrat <- RAFOatp_k
    RAFOatp2_l <- RAFOatp_l
    RAFOatp_lu_ap <-  0#9.266051e+00
    RAFOatp_lu_bas <- RAFOatp_lu_ap
    RAFNtcp <- RAFOatp_l
    RAFOatp2_Int <- 7.312446e+01 
    f_fabp_avail <- 1
    f_alb_avail <- 1 
    ...
    Ka <-5e03# 5.8e05 from Rue et al. (2024)#mol/L
...
setwd("C:/Users/ptsir/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/NEW/Training/AAFE/Test")

...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/NEW/Training/AAFE/koff_02_ka_fabp")
...
fit <-  c(rep(log(1),7), log(1),rep(log(1e5),2))

lb    = c(rep(log(1e-10), 7),log(1e-3), log(1e3),log(1e1))
ub = c(rep(log(1e10), 7),  log(1e3),log(1e6), log(1e7))
...
estimated_params <- exp(optimizer$solution)
save.image("koff_02_ka_fabp.RData")

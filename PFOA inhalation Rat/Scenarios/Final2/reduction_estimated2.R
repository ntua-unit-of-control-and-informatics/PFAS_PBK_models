...
create_variable_params <- function(BW,sex,  estimated_params, fixed_params){
  ...
  koff_fabp <-  3.409551e-03#
  k_ns <-  0
  koff_a2u <- koff_alb
  reduction_factor <-  estimated_params[11]
...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Final2/reduction_estimated")
...
fit <- log(c(1.8e+01, 5e-05, 1e+03,1, 3.0e+00, 3.5e+00, 7e-05,
             2.316007e-01, 0.2, 1e-2, 1e-4))



lb = c(rep(log(1e-7),3), log(1e-3), log(1e-1), log(1e-4), log(1e-6), log(1e-4),log(1e-4),log(1e-6),log(1e-5))
ub = c(rep(log(1e5),  3),log(1e3),  log(2e1), log(1e2),  log(0.01),  log(10),log(10),log(0.1),log(1))
...
estimated_params <- exp(optimizer$solution)
save.image("reduction_estimated2.RData")

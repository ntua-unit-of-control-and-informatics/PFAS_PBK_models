...
create_variable_params <- function(BW,sex,  estimated_params, fixed_params){
  ...
  reduction_factor <- estimated_params[13]
...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Final2/reduction_estimated_different_fabp")
...
fit <- log(c(1.8e+01, 1e-04, 1e+03, 1e+01, 3.0e+00, 1e+00, 1e-04,
             2.316007e-01, 0.4, 0.1, 1,    1e-2, 1e-2))

lb = log(c(1e-2, 1e-8,1e-1, 1e0, 1e-1, 1e-1, 1e-6,1e-3, 1e-3,1e-3, 1e-1, 5e-4, 1e-3))
ub = log(c(5e1, 1e-2, 1e4,  3e2,  2e1,  1e1, 1e-4, 0.5,  0.7, 0.5, 4, 1e-1,  3e-1))
...
estimated_params <- exp(optimizer$solution)
save.image("reduction_estimated_different_fabp_NEWUOA.RData")

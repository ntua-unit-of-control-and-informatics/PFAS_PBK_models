...
fit <- log(c(1.8e+01, 5e-05, 1e+03,1, 3.0e+00, 3.5e+00, 7e-05,
             2e-01, 2e-1, 1e-2, 1e-3, 1e-4))



lb = log(c(1e-2, 1e-6,1e-1, 1e0, 1e-1, 1e-1, 1e-6,1e-3, 1e-3, 1e-4, 1e-4, 1e-6))
ub = log(c(5e1, 1e-2, 1e4,  3e2,  2e1,  1e1, 1e-4, 0.5,  0.5, 3e-1, 3e-1,  1e-3))
...
estimated_params <- exp(optimizer$solution)
save.image("reduction_estimated3.RData")

...
create_variable_params <- function(BW,sex,  estimated_params, fixed_params){
  ...
  koff_a2u <- koff_alb
  reduction_factor <-   estimated_params[12]#
...
lb = c(rep(log(1e-7),3), log(1e-3), log(1e-1), log(1e-4), log(1e-6), log(1e-4),log(1e-4),log(1e-6),log(1e-6), log(1e-4))
 ub = c(rep(log(1e5),  3),log(1e3),  log(2e1), log(1e2),  log(0.01),  log(10),log(10),log(100),log(100),log(1))
...
estimated_params <- exp(optimizer$solution)
save.image("fabp_same_fixed_ka_kfabp_reduction.RData")

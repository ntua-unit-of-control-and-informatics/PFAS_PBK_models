...
create_fixed_params <- function(user.input){
  with(as.list(user.input),{
    ...
    return(list(
      ...
      "f_lip_Ki" = f_lip_Ki,  "f_lip_Li" = f_lip_Li, "f_lip_In"= f_lip_In, "f_lip_St" = f_lip_St,
      "f_lip_Mu" = f_lip_Mu, "f_lip_Ad" = f_lip_Ad, "f_lip_Lu" = f_lip_Lu, "f_lip_Sp" = f_lip_Sp,
      "f_lip_Ht" = f_lip_Ht,   "f_lip_Br" = f_lip_Br,  "f_lip_Sk" = f_lip_Sk,  "f_lip_Bo" = f_lip_Bo,
      "f_lip_Go" = f_lip_Go, "f_lip_Re" = f_lip_Re
...
ode.func <- function(time, inits, params){
  ...
  with(as.list(c(inits, params)),{
    ...
    CKTrestf <- MKTrestf/VKTrest/(1+k_lipid*f_lip_Ki)
    CKTrestb <- MKTrestb/VKTrest
    CPTCf <- MPTCf/VPTC/(1+k_lipid*f_lip_Ki)
    CPTCb <- MPTCb/VPTC
    CDALCf <- MDALCf/VDALC/(1+k_lipid*f_lip_Ki)
    CDALCb <- MDALCb/VDALC
    CDTCf <- MDTCf/VDTC/(1+k_lipid*f_lip_Ki)
    CDTCb <- MDTCb/VDTC
    CCDCf <- MCDCf/VCDC/(1+k_lipid*f_lip_Ki)
    CCDCb <- MCDCb/VCDC
    ...
    CLTf <- MLTf/VLT/(1+k_lipid*f_lip_Li)
    CLTb <- MLTb/VLT
    ...
    CSTFf <- MSTFf/VSTF
    CSTFb <- MSTFb/VSTF
    CSTTf <- MSTTf/VSTT/(1+k_lipid*f_lip_St) # tissue concentration
    ...
    CINFf <- MINFf/VINF
    CINFb <- MINFb/VINF
    CINTf <- MINTf/VINT/(1+k_lipid*f_lip_In) # tissue concentration
    ...
    CMFf <- MMFf/VMF
    CMFb <- MMFb/VMF
    CMTf <-  MMTf/VMT/(1+k_lipid*f_lip_Mu) # tissue concentration
    ...
    CAFf <- MAFf/VAF
    CAFb <- MAFb/VAF
    CATf <- MATf/VAT/(1+k_lipid*f_lip_Ad) # tissue concentration
    ...
    CRFf <- MRFf/VRF
    CRFb <- MRFb/VRF
    CRTf <- MRTf/VRT/(1+k_lipid*f_lip_Re) # tissue concentration
    ...
    CLuFf <- MLuFf/VLuF
    CLuFb <- MLuFb/VLuF
    CLuTf <- MLuTf/VLuT/(1+k_lipid*f_lip_Lu) #tissue concentration
    ...
    CSPFf <- MSPFf/VSPF
    CSPFb <- MSPFb/VSPF
    CSPTf <-  MSPTf/VSPT/(1+k_lipid*f_lip_Sp) # tissue concentration
    ...
    CHFf <- MHFf/VHF
    CHFb <- MHFb/VHF
    CHTf <- MHTf/VHT /(1+k_lipid*f_lip_Ht)# tissue concentration
    ...
    CBrFf <- MBrFf/VBrF
    CBrFb <- MBrFb/VBrF
    CBrTf <-  MBrTf/VBrT/(1+k_lipid*f_lip_Br) # tissue concentration
    ...
    CGoFf <- MGoFf/VGoF 
    CGoFb <- MGoFb/VGoF
    CGoTf <-  MGoTf/VGoT/(1+k_lipid*f_lip_Go) # tissue concentration
    ...
    CSKFf <- MSKFf/VSKF
    CSKFb <- MSKFb/VSKF
    CSKTf <- MSKTf/VSKT /(1+k_lipid*f_lip_Sk)# tissue concentration
    ...
    CBoFf <- MBoFf/VBoF
    CBoFb <- MBoFb/VBoF
    CBoTf <- MBoTf/VBoT/(1+k_lipid*f_lip_Bo) # tissue concentration
...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Final2/lipids")

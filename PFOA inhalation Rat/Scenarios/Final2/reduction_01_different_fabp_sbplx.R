...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Final2/reduction_01_different_fabp_sbplx")
...
lb = log(c(1e-2, 1e-8,1e-1, 1e0, 1e-1, 1e-1, 1e-6,1e-3, 1e-2,1e-2, 1e-1, 5e-4, 1e-3))
...
estimated_params <- exp(optimizer$solution)
save.image("reduction_01_different_fabp_sbplx.RData")

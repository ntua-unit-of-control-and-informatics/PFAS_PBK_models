...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Final2/reduction_001_koffalb")
...
estimated_params <- exp(optimizer$solution)
save.image("reduction_001_koffalb.RData")

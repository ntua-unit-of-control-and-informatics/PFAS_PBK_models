...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_6/Training/AAFE/No_Efflux_Only_Oatp")
...
lb	= c(log(1e-2),log(1e-04), log(1e-2),log(1e-2),log(1e-2),log(1e-5),log(1e-5))
ub = c(log(1e2), log(1e2),log(1e2),log(1e2),log(1e2),log(1e8),log(1e8))

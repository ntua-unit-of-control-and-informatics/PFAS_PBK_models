...
create.params <- function(user.input){
  with(as.list(user.input),{
    ...
    if (sex == "M"){
      ...
      RAFNtcp <- RAFOatp_l
      RAFOatp2_Int <- estimated_params[4]
      KmK_baso <- estimated_params[5]
      VmK_baso <- estimated_params[6]
    }else if(sex == "F"){
      RAFOatp_k <- estimated_params[7]
      RAFOat1 <- estimated_params[8]
      RAFOat3 <- RAFOat1
      RAFUrat <- RAFOat1
...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_6/Training/AAFE/Papp")
...
fit <-  c(log(1),log(1),log(1), log(1), rep(log(1e3),2),  
          log(0.0001), log(1),log(0.1),log(1),rep(log(1e3),2),
          log(1e1))

lb	= c(log(1e-2),log(1e-2),log(1e-2),log(1e-2),  rep(log(1e3),2),
        log(1e-20),log(1e-2),log(1e-2),log(1e-2),   rep(log(1e-1),2),   
        log(1e-5))
ub =  c(log(1e2), log(1e2),log(1e2),log(1e2),  rep(log(1e6),2), 
        log(1e2),log(1e2),log(1e2),log(1e2), rep(log(1e8),2), 
        log(1e2))

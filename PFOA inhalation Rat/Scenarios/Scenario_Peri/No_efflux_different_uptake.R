...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_6/Training/AAFE/No_Efflux_different_uptake")
...
save.image("No_efflux_different_uptake.RData")

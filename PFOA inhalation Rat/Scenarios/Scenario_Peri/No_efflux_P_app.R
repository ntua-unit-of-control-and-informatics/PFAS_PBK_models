...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_6/Training/AAFE/No_Efflux_different_uptake_Papp")
...
fit <-  c(log(1),log(1),log(1), log(0.001), log(1), log(0.1),log(1),log(1),log(1e1))

lb	= c(log(1e-2),log(1e-2),log(1e-2),log(1e-04), log(1e-2),log(1e-2),log(1e-2),log(1e-2),log(1e-2))
ub = c(log(1e2), log(1e2),log(1e2),log(1e2),log(1e2),log(1e2),log(1e2),log(1e2),log(1e2))
...
save.image("No_Efflux_different_uptake_Papp.RData")

...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_6/Training/AAFE/No_Efflux")
...
fit <-  c(log(1),log(1),log(1), log(0.001), log(1), log(0.1),log(1),log(1e2),log(1e2))

lb	= c(log(1e-2),log(1e-2),log(1e-2),log(1e-04), log(1e-2),log(1e-2),log(1e-2),log(1e-5),log(1e-5))
ub = c(log(1e2), log(1e2),log(1e2),log(1e2),log(1e2),log(1e2),log(1e2),log(1e8),log(1e8))

...
create_variable_params <- function(BW,sex,  estimated_params, fixed_params){
  ...
  Ka <- 7e04 # from Rue et al. (2024)#mol/L
...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/permeability/no_IF_no_apical_one_permeability_koff_ka7e4")
...
estimated_params <- exp(optimizer$solution)
save.image("no_IF_no_apical_one_permeability_koff_ka7e4.RData")

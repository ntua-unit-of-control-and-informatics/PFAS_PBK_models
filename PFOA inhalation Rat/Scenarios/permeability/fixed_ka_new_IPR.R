...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/permeability/fixed_ka_new_IPR")
...
fit <- log(c(1.984017e+01, 2.472699e-02, 6.382949e+01, 1.117469e+02, 7.570878e+00, 7.413928e-03,
             5.071332e-07, 0.1, 2.992272e-01, 0.04,1e-5))

lb = c(rep(log(1e-5),3), log(1e-3), log(1e-1),rep(log(1e-8),2),  rep(log(Papp_RYU),1), log(1e-3), log(1e-3), log(1e-6))
ub = c(rep(log(1e5),  3),log(1e3),  log(1e2),rep(log(1e2),  2), rep(log(Papp_Kimura),1),log(0.3),log(0.3), log(1e-3) )
...
estimated_params <- exp(optimizer$solution)
save.image("fixed_ka_new_IPR.RData")

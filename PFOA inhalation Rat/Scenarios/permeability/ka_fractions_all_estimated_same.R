...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/permeability/ka_fractions_all_estimated_same")
...
fit <- log(c(1.984017e+01, 2.472699e-05, 6.382949e+03, 1.117469e+02, 7.570878e+00, 0.05, 1e5,1e5, 
             4.545368e-05, 0.5, 0.5))

lb = c(rep(log(1e-7),3), log(1e-3), log(1e-1),  rep(log(Papp_RYU),1), log(1e4),  log(1e4), log(1e-6),log(1e-2),log(1e-2))
ub = c(rep(log(1e5),  3),log(1e3),  log(2e1), rep(log(Papp_Kimura),1),log(1e6), log(1e6) , log(1e-3),log(1),log(1))
...
estimated_params <- exp(optimizer$solution)
save.image("ka_fractions_all_estimated_same.RData")

...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/permeability/new_IPR_ka_estimated")
...
fit <- log(c(1.984017e+01, 2.472699e-05, 6.382949e+03, 1.117469e+02, 7.570878e+00, 7.413928e-03,
             5.071332e-07, 0.05, 2.992272e-01,5e5, 4.545368e-05))

lb = c(rep(log(1e-7),3), log(1e-3), log(1e-1),rep(log(1e-8),2),  rep(log(Papp_RYU),1), log(1e-2), log(1e4), log(1e-6))
ub = c(rep(log(1e5),  3),log(1e3),  log(2e1),rep(log(1e1),  2), rep(log(Papp_Kimura),1),log(5), log(6e5) , log(1e-3))
...
estimated_params <- exp(optimizer$solution)
save.image("new_IPR_ka_estimated.RData")

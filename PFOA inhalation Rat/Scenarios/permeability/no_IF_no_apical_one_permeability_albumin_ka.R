...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/permeability/no_IF_no_apical_one_permeability_albumin_ka")
...
fit <- c(rep(log(1),7), rep(log(mean(c(Papp_Kimura,Papp_RYU))),1), log(1e5), log(1e-3))

lb = c(rep(log(1e-8),3), log(1e-5), log(1e-3),rep(log(1e-8),2),  rep(log(Papp_RYU),1), log(1e4), log(1e-5))
ub = c(rep(log(1e8),  3),log(1e5),  log(1e3),rep(log(1e8),  2), rep(log(100*Papp_Kimura),1),log(1e6), log(1e2) )
...
estimated_params <- exp(optimizer$solution)
save.image("no_IF_no_apical_one_permeability_albumin_ka.RData")

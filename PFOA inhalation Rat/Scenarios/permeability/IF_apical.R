...
create_variable_params <- function(BW,sex,  estimated_params, fixed_params){
  ...
  koff_alb <-  0.1#estimated_params[12]
  koff_fabp <-  koff_alb#
  koff_a2u <- koff_alb
...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/permeability/IF_apical")
...
fit <- c(rep(log(1),7), rep(log(mean(c(Papp_Kimura,Papp_RYU))),3), log(1), log(1e-3), log(1e4))

lb = c(rep(log(1e-8),3), log(1e-5), log(1e-3),rep(log(1e-8),2),  rep(log(Papp_RYU),3), log(1e-3), log(1e-5), log(1e1))
ub = c(rep(log(1e8),  3),log(1e5),  log(1e3),rep(log(1e8),  2), rep(log(10*Papp_Kimura),3),log(10), log(1e2), log(9e5) )

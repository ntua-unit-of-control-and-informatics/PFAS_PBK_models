...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/permeability/no_IF_no_apical_albumin_ka")
...
fit <- log(c(1.156351e+07, 1.000000e-08, 1.865238e+03, 1.579775e+03, 3.019376e-01, 5.858557e-03, 9.592292e-02,
             1.899153e-01, 2.185662e-02, 3.580076e-01,
             4.391126e+04, 2.699735e-04))

lb = c(rep(log(1e-8),3), log(1e-5), log(1e-3),rep(log(1e-8),2),  rep(log(Papp_RYU),3), log(1e4), log(1e-5))
ub = c(rep(log(1e8),  3),log(1e5),  log(1e3),rep(log(1e8),  2), rep(log(10*Papp_Kimura),3),log(1e6), log(1e2) )
...
estimated_params <- exp(optimizer$solution)
save.image("no_IF_no_apical_albumin_ka_run2.RData")

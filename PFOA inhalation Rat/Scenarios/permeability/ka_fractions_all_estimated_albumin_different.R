...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/permeability/ka_fractions_all_estimated_albumin_different")
...
estimated_params <- exp(optimizer$solution)
save.image("ka_fractions_all_estimated_albumin_different.RData")

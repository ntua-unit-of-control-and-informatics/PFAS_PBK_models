...
obj.func <- function(x, dataset, fixed_params){
  ...
  solution <- data.frame(deSolve::ode(times = sample_time,  func = ode.func,
                                      ...
                                      events = events,
                                      method="lsodes",rtol = 1e-03, atol = 1e-05))
...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/permeability/no_IF_apical")
...
fit <- log(c(2.923491e+01, 9.411747e-08, 3.213941e+03, 1.323091e+02, 5.895837e+00,
             5.610785e-03, 1.312511e-01, 1.512347e+00,1.512,1.512, 2.191817e-01, 4.335417e-04, 1e4))

lb = c(rep(log(1e-8),3), log(1e-5), log(1e-3),rep(log(1e-8),2),  rep(log(Papp_RYU),3), log(1e-3),  log(1e-5), log(1e1))
ub = c(rep(log(1e8),  3),log(1e5),  log(1e3),rep(log(1e8),  2), rep(log(10*Papp_Kimura),3),log(10),  log(1e-2), log(9e5) )
...
estimated_params <- exp(optimizer$solution)
save.image("no_IF_apical_low_affinity.RData")

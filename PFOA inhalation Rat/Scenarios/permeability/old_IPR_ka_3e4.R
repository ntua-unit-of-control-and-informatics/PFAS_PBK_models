...
create_variable_params <- function(BW,sex,  estimated_params, fixed_params){
  ...
  Ka <- 3e4 # from Rue et al. (2024)#mol/L
...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/permeability/old_IPR_ka_3e4")
...
estimated_params <- exp(optimizer$solution)
save.image("old_IPR_ka_3e4.RData")

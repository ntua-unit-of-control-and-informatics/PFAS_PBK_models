...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/permeability/no_IF_no_apical_one_permeability_koff_ka3e4")
...
estimated_params <- exp(optimizer$solution)
save.image("no_IF_no_apical_one_permeability_koff_ka3e4.RData")

...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/permeability/fu_fixed")
...
fit <- log(c(4.096924e+02, 9.379320e-05, 3.063877e+03, 6.700283e+02, 5.422986e-01, 2.317223e-02,
             7.245417e-08, 2.230996e-02, 4.182165e-05))

lb = c(rep(log(1e-7),3), log(1e-3), log(1e-1),rep(log(1e-8),2),  rep(log(Papp_RYU),1),log(1e-6))
ub = c(rep(log(1e5),  3),log(1e3),  log(2e1),rep(log(1e1),  2), rep(log(Papp_Kimura),1), log(1e-3))

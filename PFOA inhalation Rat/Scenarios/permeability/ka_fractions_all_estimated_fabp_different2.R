...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/permeability/ka_fractions_all_estimated_fabp_different2")
...
fit <- log(c(3.416684e+01, 1.681949e-06, 8.640175e+03, 9.217010e+01, 2.815961e+00, 2.799992e+00,
             2.774701e-02, 5.261153e+06,
             1.507899e+04, 9.551628e-05, 3.765961e+00, 1.825424e-01, 4.371305e-02, 2.796183691, 0.004720769))

lb = c(rep(log(1e-7),3), log(1e-3), log(1e-1), log(1e-4), rep(log(Papp_RYU),1), log(1e4),  log(1e4), log(1e-6),log(1e-2),log(5e-3),log(5e-3),log(1e-3),log(1e-3))
ub = c(rep(log(1e5),  3),log(1e3),  log(2e1), log(1e2), rep(log(Papp_Kimura),1),log(1e7), log(1e6) ,  log(1e-3),log(5),log(5),log(5),log(100),log(100))
...
estimated_params <- exp(optimizer$solution)
save.image("ka_fractions_all_estimated_fabp_different2.RData")

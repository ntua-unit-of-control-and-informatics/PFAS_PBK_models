...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_2_saturable_binding/Training/AAFE/new_kim_koff")
...
fit <-  c(rep(log(1),7), log(1),log(0.1), log(0.1))

lb	= c(rep(log(1e-10), 7), log(1e-3), rep(log(1e-5),2))
ub = c(rep(log(1e10), 7),  log(1e3), rep(log(1e2),2))

...
create.params <- function(user.input){
  with(as.list(user.input),{
    ...
    KmK_baso <- 1e20
    KmK_api <-  1e20
    P_liver_bile <- estimated_params[11] 
    
    RAF_papp <- 1
    
    koff_alb <- estimated_params[12] 
    koff_fabp <-  koff_alb
    koff_a2u <- koff_alb
...
obj.func <- function(x, dataset){
  ...
  score[1] <- rmsd(predictions = preds_kudo_high, observations = obs_kudo_high)/mean(unlist(obs_kudo_high))
  ...
  score[2] <- rmsd(predictions = preds_kudo_low, observations = obs_kudo_low)/mean(unlist(obs_kudo_low))
  ...
  score[3] <- rmsd(predictions = preds_kim_IV_Mtissues, observations = obs_kim_IV_Mtissues)/mean(unlist(obs_kim_IV_Mtissues))
  ...
  score[4] <- rmsd(predictions = preds_kim_OR_Mtissues, observations = obs_kim_OR_Mtissues)/mean(unlist(obs_kim_OR_Mtissues))
  ##########################
  #-------------------------
  ...
  score[5] <- rmsd(predictions = preds_kim_IV_Ftissues, observations = obs_kim_IV_Ftissues)/mean(unlist(obs_kim_IV_Ftissues))
  ...
  score[6] <- rmsd(predictions = preds_kim_OR_Ftissues, observations = obs_kim_OR_Ftissues)/mean(unlist(obs_kim_OR_Ftissues))
  ...
  score[7] <- rmsd(predictions = preds_dzi_OR_Mtissues, observations = obs_dzi_OR_Mtissues)/mean(unlist(obs_dzi_OR_Mtissues))
  ...
  score[8] <- rmsd(predictions = preds_dzi_OR_Ftissues, observations = obs_dzi_OR_Ftissues)/mean(unlist(obs_dzi_OR_Ftissues))
  ...
  score[9] <- rmsd(predictions = preds_kim_OR_Mblood, observations = obs_kim_OR_Mblood)/mean(unlist(obs_kim_OR_Mblood))
  ...
  score[10] <- rmsd(predictions = preds_kim_IV_Mblood, observations = obs_kim_IV_Mblood)/mean(unlist(obs_kim_IV_Mblood))
  ...
  score[12] <- rmsd(predictions = preds_Lup_OR_Ffeces, observations = obs_Lup_OR_Ffeces_cum)/mean(unlist(obs_Lup_OR_Ffeces_cum))
  ...
  score[13] <- rmsd(predictions = preds_Lup_OR_Furine, observations = obs_Lup_OR_Furine_cum)/mean(unlist(obs_Lup_OR_Furine_cum))
  ...
  score[14] <- rmsd(predictions = preds_Cui_OR_MurineL, observations = obs_Cui_OR_MurineL)/mean(unlist(obs_Cui_OR_MurineL))
  ...
  score[15] <- rmsd(predictions = preds_Cui_OR_MfecesL, observations = obs_Cui_OR_MfecesL)/mean(unlist(obs_Cui_OR_MfecesL))
  ...
  score[16] <- rmsd(predictions = preds_Cui_OR_MurineH, observations = obs_Cui_OR_MurineH)/mean(unlist(obs_Cui_OR_MurineH))
  ...
  score[17] <- rmsd(predictions = preds_Cui_OR_MfecesH, observations = obs_Cui_OR_MfecesH)/mean(unlist(obs_Cui_OR_MfecesH))
  ...
  score[18] <- rmsd(predictions = preds_dzi_IV_Mserum, observations = obs_dzi_IV_Mserum)/mean(unlist(obs_dzi_IV_Mserum))
  ...
  score[19] <- rmsd(predictions = preds_dzi_OR_Mserum_low, observations = obs_dzi_OR_Mserum_low)/mean(unlist(obs_dzi_OR_Mserum_low))
  ...
  score[20] <- rmsd(predictions = preds_dzi_OR_Mserum_medium, observations = obs_dzi_OR_Mserum_medium)/mean(unlist(obs_dzi_OR_Mserum_medium))
  ...
  score[21] <- rmsd(predictions = preds_dzi_OR_Mserum_high, observations = obs_dzi_OR_Mserum_high)/mean(unlist(obs_dzi_OR_Mserum_high))
  ...
  score[22] <- rmsd(predictions = preds_dzi_IV_Fserum, observations = obs_dzi_IV_Fserum)/mean(unlist(obs_dzi_IV_Fserum))
  ...
  score[23] <- rmsd(predictions = preds_dzi_OR_Fserum_low, observations = obs_dzi_OR_Fserum_low)/mean(unlist(obs_dzi_OR_Fserum_low))
  ...
  score[24] <- rmsd(predictions = preds_dzi_OR_Fserum_medium, observations = obs_dzi_OR_Fserum_medium)/mean(unlist(obs_dzi_OR_Fserum_medium))
  ...
  score[25] <- rmsd(predictions = preds_dzi_OR_Fserum_high, observations = obs_dzi_OR_Fserum_high)/mean(unlist(obs_dzi_OR_Fserum_high))
  ...
  score[27] <- rmsd(predictions = preds_kim_IV_Fblood, observations = obs_kim_IV_Fblood)/mean(unlist(obs_kim_IV_Fblood))
...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_2_saturable_binding/Training/rmsd/new_kim_alb")
...
fit <-  c(rep(log(1),7),  rep(log(1),2), log(1),log(1), log(0.1))

lb	= c(rep(log(1e-10), 7),  rep(log(1e-4),2), log(1e-2),log(1e-3), log(1e-4))
ub = c(rep(log(1e10), 7),  rep(log(1e4),2), log(1e2), log(1e3),log(1e2))

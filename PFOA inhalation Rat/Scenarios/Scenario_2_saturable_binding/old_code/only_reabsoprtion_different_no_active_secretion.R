...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_2_saturable_binding/Training/AAFE/only_reabsoprtion_different_no_active_secretion")
...
fit <-  c(rep(log(1),5), rep(log(1),3), log(1), log(0.1))

lb	= c(rep(log(1e-10), 5), rep(log(1e-3),3), log(1e-3), log(1e-2))
ub = c(rep(log(1e10), 5), rep(log(1e3),3), log(1e3), log(1))
...
estimated_params <- exp(optimizer$solution)
save.image("only_reabsoprtion_different_no_active_secretion.RData")

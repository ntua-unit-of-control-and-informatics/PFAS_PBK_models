...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_2_saturable_binding/Training/AAFE/log_space")
...
lb	= c(rep(log(1e-10), 7),log(1e-5), log(1e-5))
ub = c(rep(log(1e10), 7),log(1e3), log(1e5))
...
estimated_params <- exp(optimizer$solution)
save.image("Scenario_2_saturable_binding_aafe_spblx_max_log_space.RData")

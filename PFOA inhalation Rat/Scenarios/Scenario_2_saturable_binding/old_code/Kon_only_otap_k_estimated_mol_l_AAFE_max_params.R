...
create.params <- function(user.input){
  with(as.list(user.input),{
    ...
    f_prot_avail <- estimated_params[25]
    RAF_papp <- 1
    
    koff_alb <- estimated_params[26]
    koff_fabp <-  koff_alb
    koff_a2u <- koff_alb
...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_2_saturable_binding/Training/AAFE/max_params")
...
fit <-  c(rep(log(1),16), rep(log(3e4),6), rep(log(1),2), log(0.8), log(0.1))

lb	= c(rep(log(1e-2), 16), rep(log(1e3),6), rep(log(1e-3),2), log(0.01), log(1e-3))
ub = c(rep(log(1e2), 16), rep(log(1e6),6), rep(log(1e3),2), log(1), log(1e2))

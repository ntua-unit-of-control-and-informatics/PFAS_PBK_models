...
ode.func <- function(time, inits, params){
  with(as.list(c(inits, params)),{
    ...
    #Intestine lumen
    dMINL = QGE*CSTL - (Qfeces*CINL) - P_passive*CINL  - 
...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_2_saturable_binding/Training/AAFE/less_params2_no_reabs")
...
fit <-  c(rep(log(1),7), rep(log(3e4),3), rep(log(1),3), log(1), log(0.1))

lb	= c(rep(log(1e-10), 7), rep(log(1),3), rep(log(1e-3),3), log(1e-3), log(1e-2))
ub = c(rep(log(1e10), 7), rep(log(1e6),3), rep(log(1e3),3), log(1e3), log(1))
...
estimated_params <- exp(optimizer$solution)
save.image("less_params2_no_reabs.RData")

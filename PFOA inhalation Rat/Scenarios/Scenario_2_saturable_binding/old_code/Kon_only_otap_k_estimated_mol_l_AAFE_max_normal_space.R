...
obj.func <- function(x, dataset){
  ...
  final_score <- max(score, na.rm = TRUE)
  return(final_score)
...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_2_saturable_binding/Training/AAFE/normal_space")
...
lb	= exp(c(rep(log(1e-10), 7),log(1e-5), log(1e-3)))
ub = exp(c(rep(log(1e10), 7),log(1e3), log(1e3)))
...
save.image("Scenario_2_saturable_binding_aafe_spblx_normal_space.RData")

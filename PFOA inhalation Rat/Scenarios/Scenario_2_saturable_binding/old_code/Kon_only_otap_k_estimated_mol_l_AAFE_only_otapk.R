...
fit <-  c(rep(log(1), 5), log(0.01), log(1))

lb	= c(rep(log(1e-10), 5),log(1e-6), log(1e-3))
ub = c(rep(log(1e5), 5),log(2), log(1e3))
...
estimated_params <- exp(optimizer$solution)
save.image("Scenario_2_saturable_binding_aafe_spblx_only_oatpk.RData")

...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_2_saturable_binding/Training/AAFE/different_kon")
...
fit <-  c(rep(log(1),7), rep(log(3e4),3), rep(log(1),2),rep(log(0.1),3))

lb	= c(rep(log(1e-2), 7), rep(log(1e2),3), rep(log(1e-3),2), rep(log(1e-5),3))
ub = c(rep(log(1e2), 7), rep(log(1e6),3), rep(log(1e3),2), rep(log(1e2),3))
...
estimated_params <- exp(optimizer$solution)
save.image("different_kon.RData")

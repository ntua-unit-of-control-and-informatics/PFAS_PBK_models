...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_2_saturable_binding/Training/AAFE/new_kim_ka_0001")
...
estimated_params <- exp(optimizer$solution)
save.image("new_kim_ka_0001.RData")

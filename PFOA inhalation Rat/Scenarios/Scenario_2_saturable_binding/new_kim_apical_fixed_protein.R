...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_2_saturable_binding/Training/AAFE/new_kim_apical_fixed_protein")
...
lb	= c(rep(log(1e-4), 6),  log(1e-3), log(1e-4), rep(log(1),3))
ub = c(rep(log(1e4), 6), log(1e3),log(1e2), rep(log(1e8),3))
...
estimated_params <- exp(optimizer$solution)
save.image("new_kim_apical_fixed_protein.RData")

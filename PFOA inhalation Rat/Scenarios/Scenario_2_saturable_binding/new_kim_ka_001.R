...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_2_saturable_binding/Training/AAFE/new_kim_ka_001")
...
fit <-  c(rep(log(1),6), log(1),log(1e5), log(1e5))

lb    = c(rep(log(1e-10), 6),log(1e-3), log(1e3),log(1e1))
ub = c(rep(log(1e10), 6),  log(1e3),log(1e6), log(1e7))
...
estimated_params <- exp(optimizer$solution)
save.image("new_kim_ka_001.RData")

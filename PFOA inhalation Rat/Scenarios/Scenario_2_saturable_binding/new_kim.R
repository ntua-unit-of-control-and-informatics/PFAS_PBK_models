...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_2_saturable_binding/Training/AAFE/new_kim")
...
fit <-  c(rep(log(1),7),  rep(log(1),2), log(1), log(0.1))

lb	= c(rep(log(1e-10), 7),  rep(log(1e-4),2), log(1e-3), log(1e-4))
ub = c(rep(log(1e10), 7),  rep(log(1e4),2), log(1e3), log(1e2))

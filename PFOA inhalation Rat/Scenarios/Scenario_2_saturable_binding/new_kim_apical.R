...
setwd("C:/Users/dpjio/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Scenario_2_saturable_binding/Training/AAFE/new_kim_apical")
...
estimated_params <- exp(optimizer$solution)
save.image("new_kim_apical.RData")

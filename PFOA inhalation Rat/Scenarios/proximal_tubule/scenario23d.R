...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/proximal_tubule/scenario23d")
...
fit <-  c(rep(log(1),7), rep(log(mean(c(Papp_Kimura,Papp_RYU))),1), log(1), log(1),log(1e-3))

lb = c(rep(log(1e-20),7), rep(log(Papp_RYU),1), log(1e-3),log(1e-6), log(1e-7))
ub = c(rep(log(1e10),  7), rep(log(Papp_Kimura),1), log(1e2) ,log(10),  log(1e1))

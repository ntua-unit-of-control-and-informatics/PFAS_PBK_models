...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/proximal_tubule/scenario8")
...
fit <-  c(rep(log(1),8), log(mean(c(Papp_Kimura,Papp_RYU))), log(1),log(1e-3))

lb = c(rep(log(1e-20),8), log(Papp_RYU),log(1e-3), log(1e-5))
ub = c(rep(log(1e10),  8), log(Papp_Kimura) ,log(10),  log(1e1) )

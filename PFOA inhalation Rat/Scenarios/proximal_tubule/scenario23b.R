...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/proximal_tubule/scenario23b")
...
lb = c(rep(log(1e-20),6), rep(log(Papp_RYU),2),log(1e-3), log(1e-7), log(5e3))

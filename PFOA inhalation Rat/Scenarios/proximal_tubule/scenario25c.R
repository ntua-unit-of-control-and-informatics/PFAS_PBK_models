...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/proximal_tubule/scenario25c")
...
lb = c(rep(log(1e-20),7), rep(log(Papp_RYU),1),log(1e-3),log(1e-6), log(1e-5))
ub = c(rep(log(1e10),  7), rep(log(Papp_Kimura),1) ,log(1e1),log(10),  log(1e1) )

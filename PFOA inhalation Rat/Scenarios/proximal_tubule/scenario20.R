...
create_variable_params <- function(BW,sex,  estimated_params, fixed_params){
  ...
  if(sex == "M"){
    ...
    RAFOat3 <- estimated_params[10]
  }else{
    RAFOatp_k <- estimated_params[2]
    RAFOat3 <- estimated_params[11]
  }
...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/proximal_tubule/scenario20")
...
fit <-  c(rep(log(1),6), log(mean(c(Papp_Kimura,Papp_RYU))), log(1),log(1e-3), rep(log(1),2), log(1e5), log(1))

lb = c(rep(log(1e-20),6), log(Papp_RYU),log(5e-4), log(1e-4), rep(log(1e-20),2), log(5e3), log(0.01))
ub = c(rep(log(1e10),  6), log(Papp_Kimura) ,log(10),  log(1e1), rep(log(1e10),2), log(1e6), log(2e1) )

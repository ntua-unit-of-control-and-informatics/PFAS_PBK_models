...
setwd("/Users/eviepapakyriakopoulou/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/proximal_tubule/scenario24g")
...
fit <-  c(rep(log(1),7), rep(log(mean(c(Papp_Kimura,Papp_RYU))),1), log(1),log(1e-3))

lb = c(rep(log(1e-8),3), log(1e-4),rep(log(1e-8),3),  rep(log(Papp_RYU),1),log(1e-6), log(1e-4))
ub = c(rep(log(1e8),  3),log(1e3), rep(log(1e8),  3), rep(log(Papp_Kimura),1),log(10),  log(1e1) )

...
setwd("/Users/eviepapakyriakopoulou/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/proximal_tubule/scenario24d")
...
lb = c(rep(log(1e-20),8), rep(log(Papp_RYU),1),log(1e-3), log(1e-4))
ub = c(rep(log(1e10),  8), rep(log(Papp_Kimura),1) ,log(10),  log(1e1) )

...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/proximal_tubule/detailed_kidney_anatomy_2ParamSets_ka58")
...
estimated_params <- exp(optimizer$solution)
save.image("detailed_kidney_anatomy_2ParamSets_ka58.RData")

...
create_variable_params <- function(BW,sex,  estimated_params, fixed_params){
  ...
  CL_int <- estimated_params[7] #uL/min/million hepatocytes
...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/proximal_tubule/scenario23e")
...
fit <-  c(rep(log(1),6), log(1e-3), rep(log(mean(c(Papp_Kimura,Papp_RYU))),1), rep(log(1),2), log(1),log(1e-3))

lb = c(rep(log(1e-20),6), log(1e-5), rep(log(Papp_RYU),1),rep(log(1e-3),2), log(1e-3), log(1e-7))
ub = c(rep(log(1e10),  6), log(1e2), rep(log(Papp_Kimura),1) ,rep(log(1e1),2), log(10),  log(1e1) )

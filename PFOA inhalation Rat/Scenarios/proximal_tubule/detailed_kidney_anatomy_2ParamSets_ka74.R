...
create_variable_params <- function(BW, sex, estimated_params){
  ...
  Ka <-7e04# 5.8e05 from Rue et al. (2024)#mol/L
  CLfeces <- estimated_params[11]
...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/proximal_tubule/detailed_kidney_anatomy_2ParamSets_ka74")
...
fit <-  c(rep(log(0.01),10),  log(0.01))

lb = c(rep(log(1e-20),9),  log(1e-4), log(1e-6))
ub = c(rep(log(1e10),  9),  log(1e2),  log(1e2) )
...
estimated_params <- exp(optimizer$solution)
save.image("detailed_kidney_anatomy_2ParamSets_ka74.RData")

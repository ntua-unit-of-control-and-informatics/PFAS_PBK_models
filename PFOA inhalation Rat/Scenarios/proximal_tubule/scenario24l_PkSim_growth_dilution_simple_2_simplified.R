...
lb = c(rep(log(1e-8),3), log(1e-5),rep(log(1e-8),3),  rep(log(Papp_RYU),1), log(1e-3), log(1e-6), log(1e-5))
ub = c(rep(log(1e8),  3),log(1e5), rep(log(1e8),  3), rep(log(Papp_Kimura),1),log(1e1),log(10),  log(1e2) )

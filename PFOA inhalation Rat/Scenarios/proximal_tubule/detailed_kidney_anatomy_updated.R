...
create.params <- function(user.input){
  with(as.list(user.input),{
    ...
    Papp_RYU = RAF_papp*1.46e-6*3600 # cm/h, at pH = 6.0 from Ryu et al. (2024) [https://doi.org/10.1016/j.chemosphere.2024.142390]
    ...
    return(list('VB'=VB, 'Vplasma'=Vplasma, 'VK'=VK, 'VKB'=VKB, 
                ...
                'QBM'=QBM, 'QBA'=QBA,
                'QBR'=QBR, 'QBLu'=QBLu, 'Qfeces'=Qfeces, 'CLfeces' = CLfeces, 'feces_density'=feces_density,

...
create_variable_params <- function(BW,sex,  estimated_params, fixed_params){
  ...
  Ka <-5.8e05  # 5.8e05 from Ruy et al. (2024)#mol/L
...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/proximal_tubule/scenario23c")
...
lb = c(rep(log(1e-20),6), rep(log(Papp_RYU),2), log(1e-3),log(1e-6), log(1e-7))

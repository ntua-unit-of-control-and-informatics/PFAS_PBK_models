...
create.params <- function(user.input){
  with(as.list(user.input),{
    ...
    Papp_LIN = RAF_papp*(ClINFT_unscaled*60*1e-06*1e3*protein_per_well)/(Awell *2) #cm/h
    Papp_RYU = RAF_papp*1.46e-6*3600 # cm/h, from Ryu et al. (2024) [https://doi.org/10.1016/j.chemosphere.2024.142390]
    # We consider the value derived from Lin et al. (2023) very large, thus we use the Ryu et al. (2024) value
    Papp = Papp_RYU
    ...
    CL_hepatobiliary <- CL_int*1e-6*HEPGL*VL*60L #L/h
    ...
    return(list('VB'=VB, 'Vplasma'=Vplasma, 'VK'=VK, 'VKB'=VKB, 
                ...
                "CL_hepatobiliary" = CL_hepatobiliary,
...
obj.func <- function(x, dataset){
  ...
  exp_data <- dataset$df13 # retrieve data of Kemper 2003  (Loccisano) ORAL male feces
  colnames(exp_data)[c(2,3)] <- c("time", "concentration")
  column_names <- c("Mfeces")
  ...
  exp_data <- dataset$df14 # retrieve data of Kemper 2003  (Worley) ORAL female urine LOW
  colnames(exp_data)[c(2,3)] <- c("time", "concentration")
  ...
  exp_data <- dataset$df15 # retrieve data of Kemper 2003  (Worley) ORAL female urine MEDIUM
  colnames(exp_data)[c(2,3)] <- c("time", "concentration")
  column_names <- c("Murine")
  ...
  exp_data <- dataset$df16 # retrieve data of Kemper 2003  (Worley) ORAL female urine HIGH
  colnames(exp_data)[c(2,3)] <- c("time", "concentration")
  column_names <- c("Murine")
  ...
  exp_data <- dataset$df17 # retrieve data of Kemper 2003  (Worley) ORAL female urine LOW
  colnames(exp_data)[c(2,3)] <- c("time", "concentration")
  column_names <- c("Murine")
  ...
  exp_data <- dataset$df18 # retrieve data of Kemper 2003  (Worley) ORAL male urine MEDIUM
  colnames(exp_data)[c(2,3)] <- c("time", "concentration")
  column_names <- c("Murine")
  ...
  # Set up simulations for the 19th case, i.e.Kemper 2003 (Worley) ORAL male urine HIGH
  ...
  exp_data <- dataset$df19 # retrieve data of Kemper 2003  (Worley) ORAL male urine HIGH
  colnames(exp_data)[c(2,3)] <- c("time", "concentration")
  column_names <- c("Murine")
  ...
  # Set up simulations for the 20th case, i.e. Dzierlenga 2021, IV male serum
  ...
  exp_data <- dataset$df20 # retrieve data of Dzierlenga 2021, IV male serum
  colnames(exp_data)[c(2,3)] <- c("time", "concentration")
  column_names <- c("Cplasma")
  ...
  exp_data <- dataset$df21 # retrieve data of Dzierlenga 2021, ORAL male serum low
  colnames(exp_data)[c(2,3)] <- c("time", "concentration")
  column_names <- c("Cplasma")
  ...
  # Set up simulations for the 22nd case, i.e. Dzierlenga 2021, ORAL male serum medium
  BW <- 0.3   # body weight (kg) not reported, # body weight (kg) not reported, based on 8 week male rats from https://animal.ncku.edu.tw/p/412-1130-16363.php?Lang=en
  admin.dose_per_g <- 12 # administered dose in mg PFOA/kg BW 
  admin.dose <- admin.dose_per_g*BW*1e03 #ug PFOA
  admin.time <- 0 #time when doses are administered, in hours
  ...
  exp_data <- dataset$df22 # retrieve data of Dzierlenga 2021, ORAL male serum medium
  colnames(exp_data)[c(2,3)] <- c("time", "concentration")
  column_names <- c("Cplasma")
  ...
  exp_data <- dataset$df23 # retrieve data of Dzierlenga 2021, ORAL male serum high
  colnames(exp_data)[c(2,3)] <- c("time", "concentration")
  column_names <- c("Cplasma")
  ...
  exp_data <- dataset$df24 # retrieve data of Dzierlenga 2021, IV female serum
  colnames(exp_data)[c(2,3)] <- c("time", "concentration")
  column_names <- c("Cplasma")
  ...
  exp_data <- dataset$df25 # retrieve data of Dzierlenga 2021, ORAL female serum low
  colnames(exp_data)[c(2,3)] <- c("time", "concentration")
  column_names <- c("Cplasma")
...
setwd("C:/Users/ptsir/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/proximal_tubule/detailed_kidney_anatomy_ka74")
...
lb = c(rep(log(1e-20),9), log(1e-4))
ub = c(rep(log(1e10),  9), log(1e2) )
...
estimated_params <- exp(optimizer$solution)
save.image("detailed_kidney_anatomy_ka74.RData")
...
experiment32$Feces = (experiment32$Feces/100)*0.2*5
...
experiment33$Feces = (experiment33$Feces/100)*0.3*5
...
experiment34$Feces = (experiment34$Feces/100)*0.2*1
...
experiment35$Feces = (experiment35$Feces/100)*0.3*1

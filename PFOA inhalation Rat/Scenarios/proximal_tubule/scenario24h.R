...
create_variable_params <- function(BW,sex,  estimated_params, fixed_params){
  ...
  KmK_baso <- 1e20
  KmK_api <-   1e20
  KLfabp <-  estimated_params[12]#(1.2e5+4e4+1.9e4)  #[L/mol]*1e-3 , value from Cheng et al. (2017)
...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/proximal_tubule/scenario24h")
...
fit <-  c(rep(log(1),7), rep(log(mean(c(Papp_Kimura,Papp_RYU))),1), log(1), log(1),log(1e-3), log(1e5))

lb = c(rep(log(1e-8),3), log(1e-5),rep(log(1e-8),3),  rep(log(Papp_RYU),1), log(1e-3), log(1e-6), log(1e-4), log(1e3))
ub = c(rep(log(1e8),  3),log(1e1), rep(log(1e8),  3), rep(log(Papp_Kimura),1),log(1e1),log(10),  log(1e1), log(1e6) )

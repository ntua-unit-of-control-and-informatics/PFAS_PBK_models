...
create_params <- function(user.input){
  with(as.list(user.input),{
    ...
    # Params depended on estimated params
...
setwd("C:/Users/Ioannis/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/proximal_tubule/scenario24e")
...
fit <-  c(rep(log(1),6), rep(log(mean(c(Papp_Kimura,Papp_RYU))),2), log(1),log(1),log(1e-3))

lb = c(rep(log(1e-20),6), rep(log(Papp_RYU),2),log(1e-3),log(1e-6), log(1e-4))
ub = c(rep(log(1e10),  6), rep(log(Papp_Kimura),2),log(1e2) ,log(10),  log(1e1) )

...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/proximal_tubule/scenario24l_PkSim_growth_dilution_simple_ka")
...
fit <-  log(c(8.187380e+01, 1.756439e-05, 6.452012e+00, 4.662342e+02, 3.431360e+01, 4.526348e-01, 4.496551e-01,
            2.566791e-01, 6.258790e+04, 6.951128e-01,
            5.850449e-04))#c(rep(log(1),7), rep(log(mean(c(Papp_Kimura,Papp_RYU))),1), log(1e5), log(1),log(1e-3))

lb = c(rep(log(1e-8),3), log(1e-5),rep(log(1e-8),3),  rep(log(Papp_RYU),1), log(6e4), log(1e-6), log(1e-5))
ub = c(rep(log(1e8),  3),log(1e5), rep(log(1e8),  3), rep(log(Papp_Kimura),1),log(5e5),log(10),  log(1e2) )
...
estimated_params <- exp(optimizer$solution)
save.image("scenario24l_PkSim_growth_dilution_simple_ka.RData")

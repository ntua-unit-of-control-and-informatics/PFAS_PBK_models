...
setwd("C:/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/proximal_tubule/scenario16")
...
lb = c(rep(log(1e-20),6), log(Papp_RYU),log(5e-4), log(1e-4), rep(log(1e-20),2))

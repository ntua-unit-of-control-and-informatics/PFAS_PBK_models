...
create_variable_params <- function(BW,sex,  estimated_params, fixed_params){
  ...
  if(sex == "M"){
    RAFOatp_k <-8.585932e+01
  }else{
    RAFOatp_k <- 9.294030e-11
  }
  RAFOat3 <- 3.049661e+01
  CL_int <- 7.364464e-12 #uL/min/million hepatocytes
  RAFOatp_l <-1.802057e+02
  RAFUrat <- RAFOatp_k
  RAFOat1 <- 0
  ...
  Papp <- 1.440777e-01
  Papp_gut <- 3.354964e-01
  
  f_fabp_avail <- 4.635547e-01
  f_alb_avail <- f_fabp_avail
  
  koff_alb <-  3.223673e-01
  koff_fabp <-  koff_alb
  koff_a2u <- koff_alb

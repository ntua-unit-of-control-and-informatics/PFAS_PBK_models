...
setwd('/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Final_Inhalation_model/Training/AAFE/inhalation_permeability_2')
...
save.image("inhalation_permeability_2.RData")

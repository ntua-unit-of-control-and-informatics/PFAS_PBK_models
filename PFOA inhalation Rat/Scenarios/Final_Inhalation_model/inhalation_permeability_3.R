...
ode.func <- function(time, inits, params){
  ...
  with(as.list(c(inits, params)),{
    ...
    CUpperair <- MUA/VUA
    CLuELFf <- (MLuELFf+MLuELFb+MLuELFdust)/VLuELF
...
obj.func <- function(x, dataset, fixed_params){
  ...
  colnames(exp_data)[c(2,3)] <- c("time", "concentration")
  column_names <- c("CLuELFf","Clungtissue")
  ...
  colnames(exp_data)[c(2,3)] <- c("time", "concentration")
  column_names <- c("CLuELFf","Cliver","Clungtissue", "Ckidney")
...
setwd('/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Scenarios/Final_Inhalation_model/Training/AAFE/inhalation_permeability_3')

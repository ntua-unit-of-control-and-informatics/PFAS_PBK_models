...
write.csv(results_df,
          ...
          "C:/Users/Ioannis/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Validation/full_params_PT_excreta_restricted_Ka_58_no_papp/Cui_2010_Excreta_results.csv",
          row.names =F)

...
write.csv(results_df,
          ...
          "C:/Users/Ioannis/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Validation/full_params_PT_excreta_restricted_Ka_58_no_papp/Kemper_2003_serum_results.csv",
          row.names =F)

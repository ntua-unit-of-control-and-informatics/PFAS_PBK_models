...
write.csv(results_df,
          ...
          "C:/Users/dpjio/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Validation/Validation_koff_09_lung_different_RAF_bile/Kemper_2003_serum_results.csv",
          row.names =F)

...
df_excreta <- openxlsx::read.xlsx("Raw_Data/Kemper_2003/Kemper_Excreta.xlsx")
...
write.csv(results_df,
          "C:/Users/ptsir/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Validation/Validation_results/Kemper_2003_excreta_results.csv",
          row.names =F)

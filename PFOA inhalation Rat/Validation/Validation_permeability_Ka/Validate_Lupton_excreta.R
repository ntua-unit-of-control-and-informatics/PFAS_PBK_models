...
setwd("/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Validation/Validation_permeability_Ka")
...
load("ka_fractions_all_estimated_fabp_different_koff_only_simplified.RData")
...
write.csv(results_df,
          ...
          "/Users/user/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Validation/Validation_permeability_Ka/Lupton_2020_excreta_results.csv",
          row.names =F)

...
write.csv(results_df,
          ...
          "/Users/eviepapakyriakopoulou/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Validation/Validation_Scenario24l_PKSim_growth_dilution_simple/Lupton_2020_excreta_results.csv",
          row.names =F)

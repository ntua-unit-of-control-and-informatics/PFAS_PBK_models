...
#===============
load("full_params_PT_restricted.RData")
# Body weight 
BW <- 0.2 #kg
sex <- "M"
admin.type <-"oral"
...
write.csv(results_df,
          ...
          "C:/Users/Ioannis/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Validation/full_params_PT_restricted/Cui_2008_results.csv",
          row.names =F)

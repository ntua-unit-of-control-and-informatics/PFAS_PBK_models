...
load("scenario24i_simplified.RData")
...
write.csv(results_df,
          ...
          "/Users/eviepapakyriakopoulou/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Validation/Validation_Scenario24i/Lupton_2020_excreta_results.csv",
          row.names =F)

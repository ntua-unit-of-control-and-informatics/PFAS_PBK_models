...
write.csv(results_df,
          ...
          "C:/Users/dpjio/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Validation/Results of Scenarios Validation/Scenario_2 - different inits/Cui_2008_results.csv",
          row.names =F)

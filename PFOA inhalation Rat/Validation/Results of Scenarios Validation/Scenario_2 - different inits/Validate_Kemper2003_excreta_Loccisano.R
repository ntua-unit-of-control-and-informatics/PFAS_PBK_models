...
write.csv(results_df,
          ...
          "C:/Users/dpjio/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Validation/Results of Scenarios Validation/Scenario_2 - different inits/Kemper_2003_excreta_Loccisano_results.csv",
          row.names =F)

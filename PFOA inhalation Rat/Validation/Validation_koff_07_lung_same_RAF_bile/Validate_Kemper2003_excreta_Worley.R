...
write.csv(results_df,
          ...
          "C:/Users/dpjio/Documents/GitHub/PFAS_PBK_models/PFOA inhalation Rat/Validation/Validation_koff_07_lung_same_RAF_bile/Kemper_2003_Excreta_Worley_results.csv",
          row.names =F)
